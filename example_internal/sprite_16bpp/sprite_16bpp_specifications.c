...
GX_STUDIO_DISPLAY_INFO sprite_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_WINDOW_PROPERTIES main_window_AppleWindow_properties =
{
    GX_PIXELMAP_ID_RED_APPLE                 /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES main_window_alpha_label_properties =
{
...
GX_SLIDER_PROPERTIES main_window_alpha_slider_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    255,                                     /* maximum value                  */
...
GX_PROMPT_PROPERTIES main_window_alpha_display_properties =
{
...
GX_CONST GX_STUDIO_WIDGET main_window_alpha_display_define =
{
    "alpha_display",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_ALPHA_DISPLAY,                        /* widget id                      */
    ...
    GX_COLOR_ID_LIGHTGRAY,                   /* normal color id                */
    GX_COLOR_ID_SELECTED_FILL,               /* selected color id              */
    GX_COLOR_ID_LIGHTGRAY,                   /* disabled color id              */
    gx_studio_prompt_create,                 /* create function                */
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {342, 42, 390, 65},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_alpha_display), /* control block */
    (void *) &main_window_alpha_display_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET main_window_alpha_slider_define =
{
    "alpha_slider",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {223, 418, 408, 454},                    /* widget size                    */
    &main_window_alpha_display_define,       /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_alpha_slider), /* control block */
    (void *) &main_window_alpha_slider_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET main_window_alpha_label_define =
{
    "alpha_label",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {243, 45, 332, 62},                      /* widget size                    */
    &main_window_alpha_slider_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_alpha_label), /* control block */
    (void *) &main_window_alpha_label_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET main_window_AppleWindow_define =
{
    "AppleWindow",
    ...
    (VOID (*)(GX_WIDGET *)) AppleWindowDraw, /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {219, 96, 413, 362},                     /* widget size                    */
    &main_window_alpha_label_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_AppleWindow), /* control block */
    (void *) &main_window_AppleWindow_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_define =
{
    ...
    {-1, -2, 638, 477},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &main_window_AppleWindow_define,         /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_window_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY sprite_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = sprite_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &sprite_16bpp_display_table[display];
