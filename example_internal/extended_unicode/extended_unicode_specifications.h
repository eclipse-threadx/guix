...
#ifndef _EXTENDED_UNICODE_SPECIFICATIONS_H_
#define _EXTENDED_UNICODE_SPECIFICATIONS_H_
...
typedef struct SCREEN_BASE_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT screen_base_prompt_1;
    GX_PROMPT screen_base_prompt;
    GX_PROMPT screen_base_prompt_2;
