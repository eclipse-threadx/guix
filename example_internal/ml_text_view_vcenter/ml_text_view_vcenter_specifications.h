...
#ifndef _ML_TEXT_VIEW_VCENTER_SPECIFICATIONS_H_
#define _ML_TEXT_VIEW_VCENTER_SPECIFICATIONS_H_
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_MULTI_LINE_TEXT_VIEW main_screen_text_view_1;
    GX_SCROLLBAR main_screen_vertical_scroll;
    GX_MULTI_LINE_TEXT_VIEW main_screen_text_view_2;
    GX_MULTI_LINE_TEXT_VIEW main_screen_text_view_3;
    GX_SCROLLBAR main_screen_vertical_scroll_3;
