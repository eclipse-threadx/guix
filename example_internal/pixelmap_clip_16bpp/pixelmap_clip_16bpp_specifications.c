...
GX_STUDIO_DISPLAY_INFO pixelmap_clip_16bpp_display_table[1] =
{
    {
    "main_display",
    "main_display_canvas",
...
{
    GX_PIXELMAP_ID_RAINBOW200_ALPHA0_COMPRESS  /* wallpaper pixelmap id        */
};
...
GX_CONST GX_STUDIO_WIDGET_ENTRY pixelmap_clip_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = pixelmap_clip_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &pixelmap_clip_16bpp_display_table[display];
