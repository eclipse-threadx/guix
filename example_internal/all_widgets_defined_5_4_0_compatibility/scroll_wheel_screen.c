...
UINT day_wheel_value_format(GX_NUMERIC_SCROLL_WHEEL* wheel, INT row, GX_STRING* string)
{
    ...
    string->gx_string_length = strnlen(string->gx_string_ptr, GX_NUMERIC_SCROLL_WHEEL_STRING_BUFFER_SIZE);
...
VOID select_day()
{
    ...
    gx_widget_find((GX_WIDGET *)&scroll_wheel_screen, ID_DAY_WHEEL, GX_SEARCH_DEPTH_INFINITE, &day_wheel);

    gx_widget_find((GX_WIDGET *)&scroll_wheel_screen, ID_DAY_INPUT, GX_SEARCH_DEPTH_INFINITE, &input);
...
VOID animation_speed_set()
{
    ...
    gx_widget_find((GX_WIDGET *)&scroll_wheel_screen, ID_DAY_WHEEL, GX_SEARCH_DEPTH_INFINITE, &day_wheel);
    gx_widget_find((GX_WIDGET *)&scroll_wheel_screen, ID_YEAR_WHEEL, GX_SEARCH_DEPTH_INFINITE, &year_wheel);
    gx_widget_find((GX_WIDGET *)&scroll_wheel_screen, ID_MONTH_WHEEL, GX_SEARCH_DEPTH_INFINITE, &month_wheel);
