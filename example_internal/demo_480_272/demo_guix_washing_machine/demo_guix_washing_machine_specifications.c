...
GX_PROMPT_PROPERTIES temperature_window_water_label_2_properties =
{
...
GX_CONST GX_STUDIO_WIDGET temperature_window_water_label_2_define =
{
    "water_label_2",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {179, 123, 208, 132},                    /* widget size                    */
    &temperature_window_temperature_label_define, /* next widget definition    */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(TEMPERATURE_WINDOW_CONTROL_BLOCK, temperature_window_water_label_2), /* control block */
    (void *) &temperature_window_water_label_2_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET temperature_window_radial_slider_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {112, 60, 278, 219},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &temperature_window_water_label_2_define, /* child widget definition       */
...
GX_CONST GX_STUDIO_WIDGET main_screen_remain_minute_label_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {214, 145, 240, 158},                    /* widget size                    */
    &main_screen_remainning_time_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_radial_slider_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {88, 70, 300, 218},                      /* widget size                    */
    &main_screen_mode_normal_define,         /* next widget definition         */
    &main_screen_remain_minute_label_define, /* child widget definition        */
