...
static WEATHER_INFO weather_info_list[] = {
    { &win_San_Diego.base, GX_STRING_ID_SAN_DIEGO, 75, 82, 70, 0, GX_PIXELMAP_ID_WEATHER_ICON_CLOUDY, GX_STRING_ID_PARTLY_CLOUDY, 19, 58, San_Diego_weather_7day_info_list},
...
WEATHER_ANIMATION_INFO animation_info_list[] = {
    { ID_WEATHER_WIN, 0, -100, 3, 25, 25 },
    { ID_WIND_WIN, 10, -100, 3, 95, 95 },
    { ID_THU_WIN, 0, 500, 240, 14, 14 },
    { ID_FRI_WIN, 5, 500, 240, 53, 53 },
    { ID_SAT_WIN, 15, 500, 240, 91, 91 },
    { ID_SUN_WIN, 20, 500, 240, 130, 130 },
    { ID_TITLE, 0, 112, 112, -65, 19 },
    { 0, 0, 0, 0, 0, 0 }
};
...
static VOID init_weather_info(WEATHER_INFO *info)
{
    ...
    /* Set weather information for next 5 days. */
