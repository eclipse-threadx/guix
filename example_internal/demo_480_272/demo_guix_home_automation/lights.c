...
static LIGHT_INFO light_info_list[] = {
    { &lights_page_1.lights_page_1_kitchen, 37, 0, GX_PIXELMAP_ID_WHEEL_WHITE_COLD, GX_TRUE},
    { &lights_page_1.lights_page_1_master_bedroom, 100, 0, GX_PIXELMAP_ID_WHEEL_RED, GX_TRUE },
    { &lights_page_2.lights_page_2_kids_bedroom, 29, 0,GX_PIXELMAP_ID_WHEEL_GREEN, GX_TRUE },
    { &lights_page_2.lights_page_2_living_room, 29, 0, GX_PIXELMAP_ID_WHEEL_BLUE_DARK, GX_TRUE },
    { &lights_page_3.lights_page_3_dinning_room, 37, 0, GX_PIXELMAP_ID_WHEEL_WHITE_WARM, GX_TRUE },
    { &lights_page_3.lights_page_3_outdoor_patio, 99, 0, GX_PIXELMAP_ID_WHEEL_BLUE_LIGHT, GX_TRUE },
    { &lights_page_4.lights_page_4_office, 28, 0, GX_PIXELMAP_ID_WHEEL_PURPLE, GX_TRUE },
    { GX_NULL, 0, 0, 0, 0}
};
