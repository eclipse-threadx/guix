...
#ifndef _MENU_SPECIFICATIONS_H_
#define _MENU_SPECIFICATIONS_H_
...
#define ID_TOOLBAR_SCREEN 1
#define ID_BACK 2
#define ID_HOME_BUTTON 3
#define ID_BOOK_SCREEN 4
#define ID_TEXT_VIEW 5
...
typedef struct TOOLBAR_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_ICON toolbar_screen_icon_10_1;
    GX_PROMPT toolbar_screen_prompt_11;
    GX_TEXT_BUTTON toolbar_screen_home_2;
} TOOLBAR_SCREEN_CONTROL_BLOCK;

typedef struct BOOK_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_MULTI_LINE_TEXT_VIEW book_screen_text_view_1;
    GX_SCROLLBAR book_screen_vertical_scroll_1;
...
typedef struct BOOKSHELF_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT bookshelf_screen_prompt_1;
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_TEXT_BUTTON main_screen_booknotes;
    GX_TEXT_BUTTON main_screen_search;
