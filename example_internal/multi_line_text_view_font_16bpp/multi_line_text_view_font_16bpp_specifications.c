...
GX_STUDIO_DISPLAY_INFO multi_line_text_view_font_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_TEXT_BUTTON_PROPERTIES main_window_button_1bpp_properties =
{
...
GX_TEXT_BUTTON_PROPERTIES main_window_button_8bpp_properties =
{
...
GX_TEXT_BUTTON_PROPERTIES main_window_button_4bpp_properties =
{
...
GX_CONST GX_STUDIO_WIDGET main_window_button_4bpp_define =
{
    "button_4bpp",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    ID_BUTTON_4BPP,                          /* widget id                      */
    ...
    {214, 93, 293, 116},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_button_4bpp), /* control block */
    (void *) &main_window_button_4bpp_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET main_window_button_8bpp_define =
{
    "button_8bpp",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    ID_BUTTON_8BPP,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {214, 139, 293, 162},                    /* widget size                    */
    &main_window_button_4bpp_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_button_8bpp), /* control block */
    (void *) &main_window_button_8bpp_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET main_window_button_1bpp_define =
{
    "button_1bpp",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    ID_BUTTON_1BPP,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {214, 47, 293, 70},                      /* widget size                    */
    &main_window_button_8bpp_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_button_1bpp), /* control block */
    (void *) &main_window_button_1bpp_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_text_view_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {32, 41, 194, 190},                      /* widget size                    */
    &main_window_button_1bpp_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY multi_line_text_view_font_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = multi_line_text_view_font_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &multi_line_text_view_font_16bpp_display_table[display];
