...
#ifndef _MULTI_LINE_TEXT_VIEW_FONT_16BPP_SPECIFICATIONS_H_
#define _MULTI_LINE_TEXT_VIEW_FONT_16BPP_SPECIFICATIONS_H_
...
#define ID_BUTTON_1BPP 1
#define ID_BUTTON_8BPP 2
#define ID_BUTTON_4BPP 3
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_TEXT_BUTTON main_window_button_1bpp;
    GX_TEXT_BUTTON main_window_button_8bpp;
    GX_TEXT_BUTTON main_window_button_4bpp;
