...
GX_STUDIO_DISPLAY_INFO ml_text_input_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(ml_text_input_16bpp_display_table[0].display, props->string_id, &text);
...
GX_CHAR window_ml_text_input_buffer[200];
GX_MULTI_LINE_TEXT_INPUT_PROPERTIES window_ml_text_input_properties =
{
    0,                                       /* string id                      */
    ...
    0,                                       /* whitespace                     */
    0,                                       /* line_space                     */
    window_ml_text_input_buffer,             /* buffer                         */
    200                                      /* buffer size                    */
};
GX_SCROLLBAR_APPEARANCE  window_input_scroll_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_SLIDER_PROPERTIES window_slider_whitespace_1_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    20,                                      /* maximum value                  */
...
GX_PROMPT_PROPERTIES window_prompt_whitespace_properties =
{
...
GX_SLIDER_PROPERTIES window_slider_line_space_1_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    10,                                      /* maximum value                  */
...
GX_PROMPT_PROPERTIES window_prompt_line_space_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_input_scroll_define =
{
    "input_scroll",
    ...
    {221, 124, 240, 319},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_input_scroll), /* control block      */
    (void *) &window_input_scroll_properties /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_line_space_define =
{
    "prompt_line_space",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {181, 437, 211, 460},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt_line_space), /* control block */
    (void *) &window_prompt_line_space_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window_slider_line_space_1_define =
{
    "slider_line_space_1",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {35, 437, 175, 460},                     /* widget size                    */
    &window_prompt_line_space_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_slider_line_space_1), /* control block */
    (void *) &window_slider_line_space_1_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_7_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {29, 412, 119, 435},                     /* widget size                    */
    &window_slider_line_space_1_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt_7), /* control block          */
    (void *) &window_prompt_7_properties     /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_prompt_whitespace_define =
{
    "prompt_whitespace",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {181, 377, 211, 400},                    /* widget size                    */
    &window_prompt_7_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt_whitespace), /* control block */
    (void *) &window_prompt_whitespace_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window_slider_whitespace_1_define =
{
    "slider_whitespace_1",
    GX_TYPE_SLIDER,                          /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {35, 377, 175, 400},                     /* widget size                    */
    &window_prompt_whitespace_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_slider_whitespace_1), /* control block */
    (void *) &window_slider_whitespace_1_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_6_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {29, 351, 129, 374},                     /* widget size                    */
    &window_slider_whitespace_1_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_window_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {277, 415, 546, 452},                    /* widget size                    */
    &window_prompt_6_define,                 /* next widget definition         */
    &window_radio_button_define,             /* child widget definition        */
...
GX_CONST GX_STUDIO_WIDGET window_ml_text_input_define =
{
    "ml_text_input",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {33, 123, 241, 320},                     /* widget size                    */
    &window_prompt_2_define,                 /* next widget definition         */
    &window_input_scroll_define,             /* child widget definition        */
    offsetof(WINDOW_CONTROL_BLOCK, window_ml_text_input), /* control block     */
    (void *) &window_ml_text_input_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window_ml_text_input_define,            /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY ml_text_input_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = ml_text_input_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &ml_text_input_16bpp_display_table[display];
