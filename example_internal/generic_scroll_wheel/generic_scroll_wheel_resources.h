...
#ifndef _GENERIC_SCROLL_WHEEL_DISPLAY_1_RESOURCES_H_
#define _GENERIC_SCROLL_WHEEL_DISPLAY_1_RESOURCES_H_
...
#define GX_PIXELMAP_ID_I_MEDICATIONSGREEN_LG 5
#define GX_PIXELMAP_ID_I_MEDICATIONSRED_LG 6
#define GX_PIXELMAP_ID_I_PATIENTLIST_LG 7
