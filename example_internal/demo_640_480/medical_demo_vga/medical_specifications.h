...
typedef struct MEDS_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PIXELMAP_BUTTON meds_screen_patients_button;
    GX_PROMPT meds_screen_prompt3;
    GX_ICON meds_screen_icon3;
    GX_PIXELMAP_BUTTON meds_screen_vitals_button;
    ...
    GX_PIXELMAP_BUTTON meds_screen_meds_button;
...
typedef struct VITALS_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PIXELMAP_BUTTON vitals_screen_meds_button;
    GX_PROMPT vitals_screen_prompt2;
    GX_ICON vitals_screen_icon2;
    GX_PIXELMAP_BUTTON vitals_screen_patients_button;
    GX_PROMPT vitals_screen_prompt3;
    GX_ICON vitals_screen_icon3;
    GX_PIXELMAP_BUTTON vitals_screen_vitals_button;
    GX_PROMPT vitals_screen_prompt4;
    GX_ICON vitals_screen_icon4;
} VITALS_SCREEN_CONTROL_BLOCK;

typedef struct PATIENTS_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PIXELMAP_BUTTON patients_screen_vitals_button;
    ...
    GX_PIXELMAP_BUTTON patients_screen_meds_button;
    ...
    GX_PIXELMAP_BUTTON patients_screen_patients_button;
