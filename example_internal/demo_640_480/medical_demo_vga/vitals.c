...
int ekg_values[EKG_COUNT] = {
    ...
    0, 0, 0, 0, 0, 7, 14, 6, 2, 0, -30, 56, 36, -11, -2
...
GX_WIDGET *widget = (GX_WIDGET *) window;
    ...
    case GX_EVENT_SHOW:
        ...
        chart_area.gx_rectangle_right = vitals_screen.vitals_screen_current_rate.gx_widget_size.gx_rectangle_left - 30;
