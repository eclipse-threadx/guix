...
#ifndef _BIDI_TEXT_LINE_BREAK_STATIC_SPECIFICATIONS_H_
#define _BIDI_TEXT_LINE_BREAK_STATIC_SPECIFICATIONS_H_
...
typedef struct ML_VIEW_BASE_CONTROL_BLOCK_STRUCT
{
    GX_MULTI_LINE_TEXT_VIEW_MEMBERS_DECLARE
    GX_SCROLLBAR ml_view_base_vertical_scroll_1;
} ML_VIEW_BASE_CONTROL_BLOCK;

typedef struct SECOND_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_MULTI_LINE_TEXT_VIEW second_screen_ml_view_Arabic_1;
    GX_SCROLLBAR second_screen_vertical_scroll_1;
    ML_VIEW_BASE_CONTROL_BLOCK second_screen_ml_view_derived;
} SECOND_SCREEN_CONTROL_BLOCK;

typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_MULTI_LINE_TEXT_VIEW main_screen_ml_view_Hebrew;
    GX_PROMPT main_screen_prompt;
    GX_MULTI_LINE_TEXT_VIEW main_screen_ml_view_Arabic;
    GX_SCROLLBAR main_screen_vertical_scroll;
    GX_MULTI_LINE_TEXT_VIEW main_screen_ml_view_English;
...
extern ML_VIEW_BASE_CONTROL_BLOCK ml_view_base;
extern SECOND_SCREEN_CONTROL_BLOCK second_screen;
