...
#define GX_STYLE_ANIMATION_WRAP             0x00000010
...
#define GX_ANIMATION_SCREEN_DRAG            0x40
...
typedef struct GX_DISPLAY_STRUCT
{
    ...
    VOID                     (*gx_display_driver_horizontal_pixelmap_line_draw)(GX_DRAW_CONTEXT *context, INT xpos, INT ypos,
                                                                                INT xstart, INT xend, INT y, struct GX_FILL_PIXELMAP_INFO_STRUCT *info);
...
typedef struct GX_ANIMATION_STRUCT
{
    ...
    GX_VALUE                    gx_animation_slide_tracking_start_x;
    GX_VALUE                    gx_animation_slide_tracking_current_x;
    USHORT                      gx_animation_slide_direction;
...
UINT _gx_accordion_menu_draw(GX_ACCORDION_MENU *menu);
...
UINT _gx_text_scroll_wheel_create(GX_TEXT_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent, INT total_rows, 
                                  ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size);
UINT _gx_text_scroll_wheel_draw(GX_TEXT_SCROLL_WHEEL *wheel);
...
UINT _gx_tree_view_draw(GX_TREE_VIEW *tree);
...
UINT _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string,
...
UINT _gx_window_background_draw(GX_WINDOW *window);
...
#define gx_accordion_menu_draw                                   _gxe_accordion_menu_draw
...
#define gx_menu_draw                                             _gxe_menu_draw
#define gx_menu_insert                                           _gxe_menu_insert
#define gx_menu_remove                                           _gxe_menu_remove
#define gx_menu_text_draw                                        _gxe_menu_text_draw
...
#define gx_multi_line_text_view_draw                             _gxe_multi_line_text_view_draw
...
#define gx_progress_bar_text_draw                                _gxe_progress_bar_text_draw
...
#define gx_text_scroll_wheel_draw                                _gxe_text_scroll_wheel_draw
...
#define gx_tree_view_draw                                        _gxe_tree_view_draw
...
#define gx_window_background_draw                                _gxe_window_background_draw
...
UINT _gxe_accordion_menu_draw(GX_ACCORDION_MENU *menu);
...
UINT _gxe_multi_line_text_view_draw(GX_MULTI_LINE_TEXT_VIEW *view);
...
UINT _gxe_progress_bar_text_color_set(GX_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID normal_text_color_id,
                                      GX_RESOURCE_ID selected_text_color_id);
UINT _gxe_progress_bar_text_draw(GX_PROGRESS_BAR *progress_bar);
...
UINT _gxe_text_scroll_wheel_create(GX_TEXT_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent, INT value_count, 
                                   ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size,
                                   UINT control_block_size);
UINT _gxe_text_scroll_wheel_draw(GX_TEXT_SCROLL_WHEEL *wheel);
...
UINT _gxe_tree_view_draw(GX_TREE_VIEW *tree);
...
UINT _gxe_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string,
                           INT x_offset, INT y_offset);
...
UINT _gxe_window_background_draw(GX_WINDOW *window);
