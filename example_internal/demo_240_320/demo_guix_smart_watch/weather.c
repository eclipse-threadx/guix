...
VOID future_weather_list_children_create(GX_WIDGET *parent, SHORT city)
{
    ...
    INT  y_offset = parent->gx_widget_size.gx_rectangle_top + 100;
    GX_STRING string;
    ...
    for (count = 0; count < FUTHURE_WEATHER_COUNT; count++)
    {
        ...
        gx_utility_rectangle_define(&size, x_offset + 135, y_offset + 12, x_offset + 173, y_offset + 42);
        ...
        gx_utility_rectangle_define(&size, x_offset + 168, y_offset + 12, x_offset + 177, y_offset + 29);
        ...
        gx_utility_rectangle_define(&size, x_offset + 179, y_offset + 12, x_offset + 216, y_offset + 42);
        ...
        gx_utility_rectangle_define(&size, x_offset + 206, y_offset + 12, x_offset + 216, y_offset + 29);
