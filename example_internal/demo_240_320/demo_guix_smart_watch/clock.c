...
VOID row_widget_draw(GX_WIDGET *widget)
{
    ...
    dirty.gx_rectangle_left = widget->gx_widget_size.gx_rectangle_left + 5;
    dirty.gx_rectangle_right = widget->gx_widget_size.gx_rectangle_right - 5;
...
VOID time_list_row_create(GX_VERTICAL_LIST *list, GX_WIDGET *widget, INT index)
{
    ...
    if (!result)
    {
        gx_utility_rectangle_define(&childsize, 0, 0, 240, 75);
        ...
        /* Create city name prompt. */
        gx_utility_rectangle_define(&childsize, 10, 15, 110, 70);
        ...
        /* Create hour prompt. */
        gx_utility_rectangle_define(&childsize, 110, 5, 155, 43);
        ...
        gx_icon_create(&row->dot_up, NULL, &row->widget, GX_PIXELMAP_ID_DOT, GX_STYLE_TRANSPARENT, 0, 158, 15);
        gx_icon_create(&row->dot_down, NULL, &row->widget, GX_PIXELMAP_ID_DOT, GX_STYLE_TRANSPARENT, 0, 158, 30);

        /* Create minute prompt. */
        gx_utility_rectangle_define(&childsize, 165, 5, 235, 43);
        ...
        /* Create am/pm prompt. */
        gx_utility_rectangle_define(&childsize, 140, 40, 210, 65);
