...
GX_ICON_PROPERTIES main_window_logo_properties =
{
...
GX_PROMPT_PROPERTIES main_window_size_prompt_properties =
{
    ...
    GX_FONT_ID_PROMPT_TEXT,                  /* font id                        */
...
GX_CONST GX_STUDIO_WIDGET main_window_logo_define =
{
    "logo",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {9, 9, 134, 28},                         /* widget size                    */
    &main_window_slider_background_size_define, /* next widget definition      */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_logo), /* control block    */
    (void *) &main_window_logo_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_bird_sprite_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {33, 40, 111, 115},                      /* widget size                    */
    &main_window_logo_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
