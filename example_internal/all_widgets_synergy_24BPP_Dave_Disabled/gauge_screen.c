...
UINT gauge_event_handle(GX_WINDOW *window, GX_EVENT *event_ptr)
{
    ...
    case GX_SIGNAL(ID_GAUGE, GX_EVENT_ANIMATION_COMPLETE):
        ...
        tics = (UINT)gauge->gx_circular_gauge_info.gx_circular_gauge_info_animation_delay;
        gx_system_timer_start((GX_WIDGET *)gauge, (UINT)GX_CIRCULAR_GAUGE_TIMER, tics, tics);
        break;
