...
#ifndef _LINES_SPECIFICATIONS_H_
#define _LINES_SPECIFICATIONS_H_
...
#define ID_LINE_WIDTH 1
#define ID_LINE_ANGLE 2
#define ID_WIDTH_DISPLAY 3
#define ID_ANGLE_DISPLAY 4
#define ID_ANTI_ALIASED 5
#define ID_ROUNDED 6
#define ID_LINE_WINDOW 7
#define ID_COLOR_LIST 8
#define ID_BRUSH_ALPHA_SLIDER 9
#define ID_BRUSH_ALPHA_PROMPT 10
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_SLIDER main_window_line_width_slider;
    GX_PROMPT main_window_prompt_2;
    GX_SLIDER main_window_line_angle_slider;
    GX_PROMPT main_window_width_display;
    GX_PROMPT main_window_angle_display;
    GX_CHECKBOX main_window_aa_box;
    GX_CHECKBOX main_window_rounded_box;
    GX_WINDOW main_window_line_window;
    GX_PROMPT main_window_color_label;
    GX_DROP_LIST main_window_color_list;
...
VOID drop_list_color_create(GX_VERTICAL_LIST *, GX_WIDGET *, INT);
