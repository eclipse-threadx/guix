...
#ifndef _COLOR_CONVERT_32BPP_SPECIFICATIONS_H_
#define _COLOR_CONVERT_32BPP_SPECIFICATIONS_H_
...
typedef struct WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_CHECKBOX window_alpha;
    GX_RADIO_BUTTON window_jpeg;
    GX_RADIO_BUTTON window_png;
