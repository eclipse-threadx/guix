...
GX_STUDIO_DISPLAY_INFO text_draw_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_PROMPT_PROPERTIES main_screen_prompt_left_aligned_properties =
{
...
GX_PROMPT_PROPERTIES main_screen_prompt_center_aligned_properties =
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES main_screen_prompt_right_aligned_properties =
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_right_aligned_define =
{
    "prompt_right_aligned",
    ...
    (VOID (*)(GX_WIDGET *)) prompt_right_aligned_draw, /* drawing function override */
    GX_NULL,                                 /* event function override        */
    {183, 220, 477, 263},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_prompt_right_aligned), /* control block */
    (void *) &main_screen_prompt_right_aligned_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET main_screen_prompt_center_aligned_define =
{
    "prompt_center_aligned",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    ...
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_prompt_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) prompt_center_aligned_draw, /* drawing function override */
    GX_NULL,                                 /* event function override        */
    {183, 158, 477, 201},                    /* widget size                    */
    &main_screen_prompt_right_aligned_define, /* next widget definition        */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_prompt_center_aligned), /* control block */
    (void *) &main_screen_prompt_center_aligned_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_3_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {47, 172, 154, 189},                     /* widget size                    */
    &main_screen_prompt_center_aligned_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_left_aligned_define =
{
    "prompt_left_aligned",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_prompt_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) prompt_left_aligned_draw, /* drawing function override */
    GX_NULL,                                 /* event function override        */
    {183, 96, 477, 139},                     /* widget size                    */
    &main_screen_prompt_2_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_prompt_left_aligned), /* control block */
    (void *) &main_screen_prompt_left_aligned_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {212, 34, 402, 55},                      /* widget size                    */
    &main_screen_prompt_left_aligned_define, /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_screen_prompt_4_define,            /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_screen_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY text_draw_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = text_draw_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &text_draw_display_table[display];
