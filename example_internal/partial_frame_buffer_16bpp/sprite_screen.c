...
GX_SPRITE *sprite = &sprite_screen.sprite_screen_sprite_1;
    ...
    if (size.gx_rectangle_bottom > sprite_screen.gx_widget_size.gx_rectangle_bottom)
    {
        size.gx_rectangle_top -= sprite_screen.gx_widget_size.gx_rectangle_bottom;
        size.gx_rectangle_bottom -= sprite_screen.gx_widget_size.gx_rectangle_bottom;
    }
    if (size.gx_rectangle_top < sprite_screen.gx_widget_size.gx_rectangle_top)
    {
        size.gx_rectangle_top += sprite_screen.gx_widget_size.gx_rectangle_bottom;
        size.gx_rectangle_bottom += sprite_screen.gx_widget_size.gx_rectangle_bottom;
    }
    ...
    if (size.gx_rectangle_right > sprite_screen.gx_widget_size.gx_rectangle_right)
    {
        size.gx_rectangle_left -= sprite_screen.gx_widget_size.gx_rectangle_right;
        size.gx_rectangle_right -= sprite_screen.gx_widget_size.gx_rectangle_right;
    }
