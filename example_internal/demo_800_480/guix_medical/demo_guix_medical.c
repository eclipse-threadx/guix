...
UINT med_screen_base_event_handler(GX_WINDOW *window, GX_EVENT *myevent)
{
    ...
    case GX_SIGNAL(ID_MEDS_BUTTON, GX_EVENT_CLICKED):
        if ((GX_WINDOW *)&meds_screen != window)
        {
            ToggleScreen((GX_WIDGET *)&meds_screen, (GX_WIDGET *)window);
        }
        break;

    case GX_SIGNAL(ID_PATIENTS_BUTTON, GX_EVENT_CLICKED):
        if ((GX_WINDOW *)&patients_screen != window)
        {
            ToggleScreen((GX_WIDGET *)&patients_screen, (GX_WIDGET *)window);
        }
        break;

    case GX_SIGNAL(ID_VITALS_BUTTON, GX_EVENT_CLICKED):
        if ((GX_WINDOW *)&vitals_screen != window)
        {
