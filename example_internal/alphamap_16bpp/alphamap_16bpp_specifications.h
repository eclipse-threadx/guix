...
#ifndef _ALPHAMAP_16BPP_SPECIFICATIONS_H_
#define _ALPHAMAP_16BPP_SPECIFICATIONS_H_
...
#define ID_RADIO_BUTTON_BLUE 1
#define ID_RADIO_BUTTON_RED 2
#define ID_RADIO_BUTTON_GREEN 3
#define ID_SLIDER_ALPHA 4
#define ID_ALPHA_PROMPT 5
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_SLIDER main_window_slider_alpha;
    GX_PROMPT main_window_prompt_alpha;
...
UINT window_event_handler(GX_WINDOW *widget, GX_EVENT *event_ptr);
