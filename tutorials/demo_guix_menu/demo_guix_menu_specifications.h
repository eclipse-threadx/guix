...
#ifndef _DEMO_GUIX_MENU_SPECIFICATIONS_H_
#define _DEMO_GUIX_MENU_SPECIFICATIONS_H_
...
#define ID_SETTING_SCREEN 1
#define ID_BUTTON_RETURN 2
#define ID_SCREEN_A 3
#define ID_BUTTON_SETTING 4
#define ID_SCREEN_B 5
#define ID_BUTTON_A 6
#define ID_BUTTON_B 7
...
typedef struct SETTING_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT setting_screen_title;
    GX_PIXELMAP_BUTTON setting_screen_button_return;
    GX_PROMPT setting_screen_prompt;
} SETTING_SCREEN_CONTROL_BLOCK;

typedef struct SCREEN_A_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PROMPT screen_a_title;
    GX_PIXELMAP_BUTTON screen_a_button_setting;
    GX_PROMPT screen_a_prompt_1;
    GX_PIXELMAP_BUTTON screen_a_button_return;
    GX_PROMPT screen_a_prompt;
} SCREEN_A_CONTROL_BLOCK;

typedef struct SCREEN_B_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PROMPT screen_b_title;
    GX_PIXELMAP_BUTTON screen_b_button_setting;
    GX_PROMPT screen_b_prompt_1;
    GX_PIXELMAP_BUTTON screen_b_button_return;
    GX_PROMPT screen_b_prompt;
} SCREEN_B_CONTROL_BLOCK;
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PIXELMAP_BUTTON main_screen_button_a;
    GX_PROMPT main_screen_prompt_1;
    GX_PIXELMAP_BUTTON main_screen_button_b;
...
extern SETTING_SCREEN_CONTROL_BLOCK setting_screen;
extern SCREEN_A_CONTROL_BLOCK screen_a;
extern SCREEN_B_CONTROL_BLOCK screen_b;
