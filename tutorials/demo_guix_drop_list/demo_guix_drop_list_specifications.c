...
GX_STUDIO_DISPLAY_INFO demo_guix_drop_list_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
...
GX_DROP_LIST_PROPERTIES main_screen_drop_list_properties =
{
...
GX_PROMPT_PROPERTIES main_screen_selected_string_properties =
{
...
GX_PROMPT_PROPERTIES main_screen_label_properties =
{
...
GX_NUMERIC_PROMPT_PROPERTIES main_screen_selected_index_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET main_screen_selected_index_define =
{
    "selected_index",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {182, 100, 477, 147},                    /* widget size                    */
    &main_screen_logo_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_selected_index), /* control block */
    (void *) &main_screen_selected_index_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_label_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {60, 113, 171, 130},                     /* widget size                    */
    &main_screen_selected_index_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_label_define =
{
    "label",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {60, 179, 164, 196},                     /* widget size                    */
    &main_screen_label_1_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_label), /* control block   */
    (void *) &main_screen_label_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_screen_selected_string_define =
{
    "selected_string",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {182, 165, 477, 212},                    /* widget size                    */
    &main_screen_label_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_selected_string), /* control block */
    (void *) &main_screen_selected_string_properties /* extended properties    */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_title_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {259, 42, 354, 65},                      /* widget size                    */
    &main_screen_selected_string_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_title), /* control block   */
    (void *) &main_screen_title_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_screen_drop_list_define =
{
    "drop_list",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {182, 230, 477, 273},                    /* widget size                    */
    &main_screen_title_define,               /* next widget definition         */
    &main_screen_drop_list_button_define,    /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_drop_list), /* control block */
    (void *) &main_screen_drop_list_properties /* extended properties          */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_screen_drop_list_define,           /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_screen_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY demo_guix_drop_list_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = demo_guix_drop_list_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &demo_guix_drop_list_display_table[display];
