...
#ifndef _DEMO_GUIX_DROP_LIST_SPECIFICATIONS_H_
#define _DEMO_GUIX_DROP_LIST_SPECIFICATIONS_H_
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_DROP_LIST main_screen_drop_list;
    GX_PIXELMAP_BUTTON main_screen_drop_list_button;
    GX_PROMPT main_screen_title;
    GX_PROMPT main_screen_selected_string;
    GX_PROMPT main_screen_label;
    GX_PROMPT main_screen_label_1;
    GX_NUMERIC_PROMPT main_screen_selected_index;
