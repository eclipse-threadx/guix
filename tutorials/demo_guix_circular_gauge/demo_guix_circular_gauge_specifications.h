...
#ifndef _DEMO_GUIX_CIRCULAR_GAUGE_SPECIFICATIONS_H_
#define _DEMO_GUIX_CIRCULAR_GAUGE_SPECIFICATIONS_H_
...
#define ID_POS_1 1
#define ID_POS_2 2
#define ID_SPEED_VAL2 3
#define ID_SPEED_VAL1 4
#define ID_GAUGE_1 5
#define ID_GAUGE_2 6
...
typedef struct GAUGE_WINDOW_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_PIXELMAP_SLIDER gauge_window_pixelmap_slider;
    GX_ICON gauge_window_icon_1;
    GX_ICON gauge_window_icon_2;
    GX_PIXELMAP_SLIDER gauge_window_pixelmap_slider_1;
    GX_ICON gauge_window_icon_3;
    GX_ICON gauge_window_icon_4;
    GX_PROMPT gauge_window_speed_value_2;
    GX_PROMPT gauge_window_speed_value_1;
    GX_PROMPT gauge_window_prompt_1;
    GX_PROMPT gauge_window_prompt_2;
    GX_CIRCULAR_GAUGE gauge_window_gauge_1;
    GX_CIRCULAR_GAUGE gauge_window_gauge_2;
    GX_ICON gauge_window_logo;
} GAUGE_WINDOW_CONTROL_BLOCK;


/* extern statically defined control blocks                                    */

#ifndef GUIX_STUDIO_GENERATED_FILE
extern GAUGE_WINDOW_CONTROL_BLOCK gauge_window;
#endif
