...
#ifndef _DEMO_GUIX_VERTICAL_LIST_SPECIFICATIONS_H_
#define _DEMO_GUIX_VERTICAL_LIST_SPECIFICATIONS_H_
...
#define ID_BUTTON_TOTAL_ROWS_SET 7
#define ID_TEXT_INPUT_TOTAL_ROWS_SET 8
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_VERTICAL_LIST main_screen_vertical_list_scroll;
    ...
    GX_VERTICAL_LIST main_screen_vertical_list_wrap;
    GX_VERTICAL_LIST main_screen_vertical_list;
    GX_TEXT_BUTTON main_screen_button_1;
    GX_TEXT_BUTTON main_screen_button_2;
    GX_TEXT_BUTTON main_screen_button_3;
    GX_TEXT_BUTTON main_screen_button_4;
    GX_ICON main_screen_logo;
    GX_PROMPT main_screen_title;
    GX_TEXT_BUTTON main_screen_button_total_rows_set;
    GX_SINGLE_LINE_TEXT_INPUT main_screen_text_input_total_rows_set;
...
VOID vertical_list_row_create(GX_VERTICAL_LIST *, GX_WIDGET *, INT);
