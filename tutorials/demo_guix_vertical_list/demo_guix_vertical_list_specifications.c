...
/*  Date (dd.mm.yyyy): 23. 3.2022   Time (hh:mm): 15:06                        */
/*******************************************************************************/
...
GX_STUDIO_DISPLAY_INFO demo_guix_vertical_list_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(demo_guix_vertical_list_display_table[0].display, props->string_id, &text);
...
GX_VERTICAL_LIST_PROPERTIES main_screen_vertical_list_scroll_properties =
{
    0,                                       /* wallpaper id                   */
    vertical_list_row_create,                /* callback function              */
    20                                       /* total rows                     */
};
...
GX_VERTICAL_LIST_PROPERTIES main_screen_vertical_list_wrap_properties =
{
    0,                                       /* wallpaper id                   */
    vertical_list_row_create,                /* callback function              */
    20                                       /* total rows                     */
};
GX_VERTICAL_LIST_PROPERTIES main_screen_vertical_list_properties =
{
    0,                                       /* wallpaper id                   */
...
GX_TEXT_BUTTON_PROPERTIES main_screen_button_4_properties =
{
...
GX_TEXT_BUTTON_PROPERTIES main_screen_button_total_rows_set_properties =
{
...
GX_CHAR main_screen_text_input_total_rows_set_buffer[100];
GX_SINGLE_LINE_TEXT_INPUT_PROPERTIES main_screen_text_input_total_rows_set_properties =
{
    ...
    GX_COLOR_ID_READONLY_FILL,               /* readonly fill color            */
    GX_COLOR_ID_READONLY_TEXT,               /* readonly text color            */
    main_screen_text_input_total_rows_set_buffer, /* buffer                    */
    100,                                     /* buffer size                    */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_button_4_define =
{
    "button_4",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {459, 266, 606, 324},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_button_4), /* control block */
    (void *) &main_screen_button_4_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_button_3_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {459, 207, 606, 265},                    /* widget size                    */
    &main_screen_button_4_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_text_input_total_rows_set_define =
{
    "text_input_total_rows_set",
    GX_TYPE_SINGLE_LINE_TEXT_INPUT,          /* widget type                    */
    ID_TEXT_INPUT_TOTAL_ROWS_SET,            /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {481, 362, 522, 398},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_text_input_total_rows_set), /* control block */
    (void *) &main_screen_text_input_total_rows_set_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET main_screen_button_total_rows_set_define =
{
    "button_total_rows_set",
    GX_TYPE_TEXT_BUTTON,                     /* widget type                    */
    ID_BUTTON_TOTAL_ROWS_SET,                /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_RAISED|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {310, 361, 470, 398},                    /* widget size                    */
    &main_screen_text_input_total_rows_set_define, /* next widget definition   */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_button_total_rows_set), /* control block */
    (void *) &main_screen_button_total_rows_set_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_title_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {247, 30, 364, 50},                      /* widget size                    */
    &main_screen_button_total_rows_set_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_vertical_list_define =
{
    "vertical_list",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {458, 88, 607, 325},                     /* widget size                    */
    &main_screen_logo_define,                /* next widget definition         */
    &main_screen_button_1_define,            /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_vertical_list), /* control block */
    (void *) &main_screen_vertical_list_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET main_screen_vertical_list_wrap_define =
{
    "vertical_list_wrap",
    GX_TYPE_VERTICAL_LIST,                   /* widget type                    */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {268, 88, 417, 322},                     /* widget size                    */
    &main_screen_vertical_list_define,       /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_vertical_list_wrap), /* control block */
    (void *) &main_screen_vertical_list_wrap_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_text_input_selected_set_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {237, 414, 278, 450},                    /* widget size                    */
    &main_screen_vertical_list_wrap_define,  /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_vertical_list_scroll_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {66, 85, 215, 319},                      /* widget size                    */
    &main_screen_text_input_page_index_define, /* next widget definition       */
    &main_screen_vertical_scroll_define,     /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_vertical_list_scroll), /* control block */
    (void *) &main_screen_vertical_list_scroll_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_screen_vertical_list_scroll_define, /* child widget                  */
    0,                                       /* control block                  */
    (void *) &main_screen_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY demo_guix_vertical_list_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = demo_guix_vertical_list_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &demo_guix_vertical_list_display_table[display];
