...
#ifndef _DEMO_GUIX_ML_TEXT_INPUT_SPECIFICATIONS_H_
#define _DEMO_GUIX_ML_TEXT_INPUT_SPECIFICATIONS_H_
...
#define ID_CURSOR_WIDTH_INPUT 2
#define ID_CURSOR_HEIGHT_INPUT 3
#define ID_ALIGN_LEFT 4
#define ID_ALIGN_CENTER 5
#define ID_ALIGN_RIGHT 6
#define ID_SLIDER_WHITESPACE 7
#define ID_SLIDER_LINE_SPACE 8
#define ID_FONT_SMALL 9
#define ID_FONT_MEDIUM 10
#define ID_PROMPT_WHITESPACE 11
#define ID_PROMPT_LINE_SPACE 12
#define ID_SELECT_ALL 13
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_MULTI_LINE_TEXT_INPUT main_screen_ml_text_input;
    GX_SCROLLBAR main_screen_input_scroll;
    GX_CHECKBOX main_screen_scrollbar;
    GX_SINGLE_LINE_TEXT_INPUT main_screen_cursor_width_input;
    GX_SINGLE_LINE_TEXT_INPUT main_screen_cursor_height_input;
    ...
    GX_PIXELMAP_SLIDER main_screen_slider_whitespace;
    GX_PIXELMAP_SLIDER main_screen_slider_line_space;
    ...
    GX_NUMERIC_PROMPT main_screen_prompt_whitespace;
    GX_NUMERIC_PROMPT main_screen_prompt_line_space;
