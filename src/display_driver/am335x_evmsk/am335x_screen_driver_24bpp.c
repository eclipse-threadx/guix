...
void am335x_24bpp_buffer_toggle(GX_CANVAS *canvas, GX_RECTANGLE *dirty)
{
    GX_RECTANGLE Limit;
    GX_RECTANGLE Copy;
    int x,y;
...
UINT am335x_graphics_driver_24bpp(GX_DISPLAY *display)
{
    ...
    */
    ...
    display -> gx_display_color_format                  = GX_COLOR_FORMAT_24BIT_XRGB;
    display -> gx_display_driver_canvas_copy            = _gx_display_driver_24bpp_canvas_copy;
    display -> gx_display_driver_canvas_blend      	    = _gx_display_driver_24bpp_canvas_blend;
    ...
    display -> gx_display_driver_horizontal_line_draw   = _gx_display_driver_24bpp_horizontal_line_draw;
    display -> gx_display_driver_vertical_line_draw     = _gx_display_driver_24bpp_vertical_line_draw;
    display -> gx_display_driver_horizontal_pattern_line_draw   = _gx_display_driver_24bpp_horizontal_pattern_line_draw;
    display -> gx_display_driver_vertical_pattern_line_draw     = _gx_display_driver_24bpp_vertical_pattern_line_draw;
    display -> gx_display_driver_pixelmap_draw          = _gx_display_driver_24bpp_pixelmap_draw;
    display -> gx_display_driver_polygon_draw           = _gx_display_driver_24bpp_polygon_draw;

    display -> gx_display_driver_pixel_write            = _gx_display_driver_24bpp_pixel_write;
    display -> gx_display_driver_pixel_blend            = _gx_display_driver_24bpp_pixel_blend;
    display -> gx_display_driver_block_move             = _gx_display_driver_24bpp_block_move;
    display -> gx_display_driver_native_color_get       = _gx_display_driver_24bpp_native_color_get;
    display -> gx_display_driver_buffer_toggle          = am335x_24bpp_buffer_toggle;
