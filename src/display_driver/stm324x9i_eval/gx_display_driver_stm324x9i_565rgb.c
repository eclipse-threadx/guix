...
/*    Override generic function to utilize DMA2D                          */
/**************************************************************************/
static void stm32f429_565rgb_buffer_toggle(GX_CANVAS *canvas, GX_RECTANGLE *dirty)
{
GX_RECTANGLE    Limit;
GX_RECTANGLE    Copy;
ULONG           offset;
...
/*   services.                                                            */
/**************************************************************************/
UINT stm32f429_graphics_driver_setup_565rgb(GX_DISPLAY *display)
{
    ...
    */
    _gx_display_driver_565rgb_setup(display, (VOID*)STM32F429_DISCO_SCREEN_HANDLE, stm32f429_565rgb_buffer_toggle);
