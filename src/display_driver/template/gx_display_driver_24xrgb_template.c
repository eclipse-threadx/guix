...
*/
/**************************************************************************/
static void generic_buffer_toggle_24xrgb(GX_CANVAS *canvas, GX_RECTANGLE *copy)
{
...
/**************************************************************************/
/*
  ConfigureDisplayHardware24xrgb
    1) Do low-level hardware setup
    2) Initialize frame buffer pointer(s)
*/
/**************************************************************************/
static void ConfigureDisplayHardware24xrgb(GX_DISPLAY *display)
{
    INT buffer_size;
...
/**************************************************************************/
UINT template_graphics_driver_setup_24xrgb(GX_DISPLAY *display)
{
    _gx_display_driver_24xrgb_setup(display, GX_NULL, generic_buffer_toggle_24xrgb);

    display -> gx_display_handle = DISPLAY_HANDLE;
    ConfigureDisplayHardware24xrgb(display);
    return GX_SUCCESS;
}
