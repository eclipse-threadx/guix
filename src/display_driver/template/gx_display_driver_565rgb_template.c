...
*** NOTE ***
    The display and canvas X-resolution must be an even modulo-2 value,
    because this function copies ULONGs to improve the speed of the buffer
    toggle operation.
*/
/**************************************************************************/
static void generic_buffer_toggle_16bpp(GX_CANVAS *canvas, GX_RECTANGLE *copy)
{
...
*/
/**************************************************************************/
static void ConfigureDisplayHardware16bpp(GX_DISPLAY *display)
{
    INT buffer_size;
...
/**************************************************************************/
UINT template_graphics_driver_setup_565rgb(GX_DISPLAY *display)
{
    /* install all of the generic 565 rgb mode drawing functions */
    _gx_display_driver_565rgb_setup(display, GX_NULL, generic_buffer_toggle_16bpp);
    
    display -> gx_display_handle = DISPLAY_HANDLE;
    ConfigureDisplayHardware16bpp(display);
