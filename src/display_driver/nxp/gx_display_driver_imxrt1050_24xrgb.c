...
static UINT _gx_rt1050_graphics_layer_initialize(INT layer, GX_CANVAS *canvas)
{
    ...
    canvas->gx_canvas_memory_size = FRAME_BUFFER_PIXELS * sizeof(GX_COLOR);
    return GX_SUCCESS;
}
...
UINT gx_display_driver_imxrt1050_24xrgb_setup(GX_DISPLAY *display)
{
    _gx_display_driver_24xrgb_setup(display, GX_NULL, _gx_display_driver_imxrt1050_buffer_toggle);
