...
ULONG      display_1_canvas_memory[230400];

extern GX_CONST GX_THEME *display_1_theme_table[];
extern GX_CONST GX_STRING *display_1_language_table[];

GX_STUDIO_DISPLAY_INFO demo_jpeg_decode_24xrgb_rotated_cw_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
    ...
    921600,                                  /* canvas memory size in bytes    */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY demo_jpeg_decode_24xrgb_rotated_cw_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = demo_jpeg_decode_24xrgb_rotated_cw_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &demo_jpeg_decode_24xrgb_rotated_cw_display_table[display];
