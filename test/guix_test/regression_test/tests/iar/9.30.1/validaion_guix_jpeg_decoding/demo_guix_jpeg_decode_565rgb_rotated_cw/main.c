...
#include "demo_jpeg_decode_565rgb_rotated_cw_resources.h"
#include "demo_jpeg_decode_565rgb_rotated_cw_specifications.h"
...
GX_CANVAS *canvas;
    ...
    gx_studio_display_configure(DISPLAY_1, graphics_driver_565rgb_rotated_setup, LANGUAGE_ENGLISH, DISPLAY_1_THEME_1, &root);
...
MAP_INFO map_info_list[]={
  ...
  test_jpeg_to_pixelmap_draw(root->gx_window_root_canvas, window, map_info_list, DISPLAY_1_COLOR_FORMAT, GX_IMAGE_READER_MODE_ROTATE_CW, frame_id++);
}