...
#include "demo_jpeg_decode_8bit_palette_resources.h"
#include "demo_jpeg_decode_8bit_palette_specifications.h"
...
GX_CANVAS *canvas;
    ...
    gx_studio_display_configure(DISPLAY_1, graphics_driver_8bit_palette_setup, LANGUAGE_ENGLISH, DISPLAY_1_THEME_1, &root);
...
MAP_INFO map_info_list[]={
  ...
  test_jpeg_to_pixelmap_draw(root->gx_window_root_canvas, window, map_info_list, DISPLAY_1_COLOR_FORMAT, 0, frame_id++);
}