...
#include "gx_api.h"
#include "test_unique_bidi_text_reference_check_resources.h"
...
GX_CONST GX_UBYTE display_1_STRING_1_TEXT_VIEW_Hebrew[] = "text_view";
GX_CONST GX_UBYTE display_1_STRING_1_ML_VIEW_TEMPLATE_Hebrew[] = "text_view";

/* String Table for display_1 language Hebrew                                  */

GX_CONST GX_STRING display_1_Hebrew_string_table[3] =
{
    {GX_NULL, 0},
    {(GX_CONST GX_CHAR *)display_1_STRING_1_TEXT_VIEW_Hebrew, sizeof(display_1_STRING_1_TEXT_VIEW_Hebrew) - 1}
    {(GX_CONST GX_CHAR *)display_1_STRING_1_ML_VIEW_TEMPLATE_Hebrew, sizeof(display_1_STRING_1_ML_VIEW_TEMPLATE_Hebrew) - 1}
};
