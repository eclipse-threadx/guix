...
GX_CONST GX_COLOR secondary_display_theme_1_color_table[] =
{
    0x00000000,
    0x00007bef,
    0x0000e71c,
...
GX_CONST GX_FONT *secondary_display_theme_1_font_table[] =
{
...
static GX_CONST USHORT SECONDARY_DISPLAY_THEME_1_RADIO_ON_pixelmap_data[308] =
{
...
GX_CONST GX_PIXELMAP SECONDARY_DISPLAY_THEME_1_RADIO_ON_pixelmap =
{
    ...
    (GX_UBYTE *) SECONDARY_DISPLAY_THEME_1_RADIO_ON_pixelmap_data,
    sizeof(SECONDARY_DISPLAY_THEME_1_RADIO_ON_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
...
static GX_CONST USHORT SECONDARY_DISPLAY_THEME_1_RADIO_OFF_pixelmap_data[308] =
{
...
GX_CONST GX_PIXELMAP SECONDARY_DISPLAY_THEME_1_RADIO_OFF_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED|GX_PIXELMAP_ALPHA,         /* flags                 */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) SECONDARY_DISPLAY_THEME_1_RADIO_OFF_pixelmap_data,
    sizeof(SECONDARY_DISPLAY_THEME_1_RADIO_OFF_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
static GX_CONST USHORT SECONDARY_DISPLAY_THEME_1_CHECKBOX_ON_pixelmap_data[242] =
{
...
GX_CONST GX_PIXELMAP SECONDARY_DISPLAY_THEME_1_CHECKBOX_ON_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED,                  /* flags                          */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) SECONDARY_DISPLAY_THEME_1_CHECKBOX_ON_pixelmap_data,
    sizeof(SECONDARY_DISPLAY_THEME_1_CHECKBOX_ON_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
static GX_CONST USHORT SECONDARY_DISPLAY_THEME_1_CHECKBOX_OFF_pixelmap_data[217] =
{
    0x800f, 0x1a90, 0x000f, 0x1a90, 0xbe17, 0xe6d8, 0xde97, 0xde75, 0xde74, 0xde53, 
...
GX_CONST GX_PIXELMAP SECONDARY_DISPLAY_THEME_1_CHECKBOX_OFF_pixelmap =
{
    0x00000001,                              /* major version                  */
    0x00000000,                              /* minor version                  */
    GX_PIXELMAP_COMPRESSED,                  /* flags                          */
    GX_COLOR_FORMAT_565RGB,                  /* Format                         */
    (GX_UBYTE *) SECONDARY_DISPLAY_THEME_1_CHECKBOX_OFF_pixelmap_data,
    sizeof(SECONDARY_DISPLAY_THEME_1_CHECKBOX_OFF_pixelmap_data),    /* the size of pixelmap_data*/
    NULL,
    0,                                       /* auxiliary data size            */
    0x00,                                    /* used for transparent iamges    */
    16,                                      /* width in pixel                 */
...
GX_CONST GX_PIXELMAP *secondary_display_theme_1_pixelmap_table[] =
{
    GX_NULL,
    &SECONDARY_DISPLAY_THEME_1_RADIO_ON_pixelmap,
    &SECONDARY_DISPLAY_THEME_1_RADIO_OFF_pixelmap,
    &SECONDARY_DISPLAY_THEME_1_CHECKBOX_ON_pixelmap,
    &SECONDARY_DISPLAY_THEME_1_CHECKBOX_OFF_pixelmap
};

/* String values                                                               */

GX_CONST GX_UBYTE secondary_display_STRING_1_English[] = "prompt";

/* String Table for secondary_display language English                         */

GX_CONST GX_STRING secondary_display_English_string_table[2] =
{
    {GX_NULL, 0},
    {(GX_CONST GX_CHAR *)secondary_display_STRING_1_English, sizeof(secondary_display_STRING_1_English) - 1}
};

/*  Language Table                                                             */


GX_CONST GX_STRING *secondary_display_language_table[1] = 
{
    secondary_display_English_string_table,
};

GX_THEME secondary_display_theme_1 =
{
    (GX_COLOR *) secondary_display_theme_1_color_table,
    (GX_FONT **) secondary_display_theme_1_font_table,
    (GX_PIXELMAP **) secondary_display_theme_1_pixelmap_table,
    NULL,
    {
        20,                                  /* scroll width                   */
        18,                                  /* thumb width                    */
...
GX_CONST GX_THEME *secondary_display_theme_table[1] =
{
    &secondary_display_theme_1
};
