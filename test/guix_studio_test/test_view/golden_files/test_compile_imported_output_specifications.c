...
#include <stddef.h>
#include "test_compile_imported_output_resources.h"
#include "test_compile_imported_output_specifications.h"
...
GX_STUDIO_DISPLAY_INFO test_compile_imported_output_display_table[1] =
{
    {
    "main_display",
    "main_display_canvas",
...
GX_CONST GX_STUDIO_WIDGET_ENTRY test_compile_imported_output_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = test_compile_imported_output_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &test_compile_imported_output_display_table[display];
