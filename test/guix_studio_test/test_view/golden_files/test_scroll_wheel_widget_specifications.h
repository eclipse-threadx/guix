...
#ifndef _TEST_SCROLL_WHEEL_WIDGET_SPECIFICATIONS_H_
#define _TEST_SCROLL_WHEEL_WIDGET_SPECIFICATIONS_H_
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_NUMERIC_SCROLL_WHEEL main_screen_numeric_scroll_wheel;
    GX_STRING_SCROLL_WHEEL main_screen_string_scroll_wheel;
