...
/*  Date (dd.mm.yyyy): 18. 1.2019   Time (hh:mm): 15:41                        */
/*******************************************************************************/


#ifndef _TRIGGER_TARGET_RENAME_SPECIFICATIONS_H_
#define _TRIGGER_TARGET_RENAME_SPECIFICATIONS_H_
...
#define IDB_OK 1
#define IDB_CANCEL 2
#define ID_BUTTON_SCREEN 3
#define ID_TEXT_BUTTON 4
#define ID_CHECKBOX 5
#define ID_RADIO_BUTTON 6
#define ID_PIXELMAP_BUTTON 7
#define ID_ICON 8
#define ID_ICON_BUTTON 9
#define IDB_NEXT 10
...
typedef struct POPUP_MODAL_TEST_NAME_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_TEXT_BUTTON popup_modal_test_name_OK_button;
    GX_TEXT_BUTTON popup_modal_test_name_cancel_button;
    GX_MULTI_LINE_TEXT_VIEW popup_modal_test_name_text_view_2;
    GX_WINDOW popup_modal_test_name_window_1;
    GX_PROMPT popup_modal_test_name_prompt_5;
} POPUP_MODAL_TEST_NAME_CONTROL_BLOCK;
...
typedef struct BUTTON_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_WINDOW button_screen_test_button_window;
    GX_TEXT_BUTTON button_screen_next_button_7;
...
extern POPUP_MODAL_TEST_NAME_CONTROL_BLOCK popup_modal_test_name;
