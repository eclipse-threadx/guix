...
/*  Date (dd.mm.yyyy):  1. 9.2022   Time (hh:mm): 17:56                        */
/*******************************************************************************/
...
#include "test_add_widget_8bpp_specifications.h"
...
GX_STUDIO_DISPLAY_INFO test_add_widget_8bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CONST GX_STUDIO_WIDGET_ENTRY test_add_widget_8bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = test_add_widget_8bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    USHORT language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &test_add_widget_8bpp_display_table[display];
