...
#include <stddef.h>
#include "test_copy_paste_resources.h"
#include "test_copy_paste_specifications.h"

static GX_WIDGET *gx_studio_nested_widget_create(GX_BYTE *control, GX_CONST GX_STUDIO_WIDGET *definition, GX_WIDGET *parent);
PARENT_SCREEN_CONTROL_BLOCK parent_screen;
...
GX_STUDIO_DISPLAY_INFO test_copy_paste_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(test_copy_paste_display_table[0].display, props->string_id, &text);
...
GX_CONST GX_STUDIO_WIDGET base_button_define =
{
    "button",
    ...
    {360, 228, 439, 251},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(BASE_CONTROL_BLOCK, base_button), /* control block                */
...
GX_CONST GX_STUDIO_WIDGET base_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &base_button_define,                     /* child widget                   */
    0,                                       /* control block                  */
    (void *) &base_properties                /* extended properties            */
};
GX_WINDOW_PROPERTIES parent_screen_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_TEMPLATE_PROPERTIES parent_screen_derived_properties =
{
    &base_define,                            /* base info                      */
    gx_studio_window_create,                 /* base create function           */
    {0, 0, 799, 479}                         /* widget size                    */
};
GX_PROMPT_PROPERTIES parent_screen_prompt_6_properties =
{
...
GX_TEMPLATE_PROPERTIES parent_screen_derived_1_properties =
{
    &base_define,                            /* base info                      */
    gx_studio_window_create,                 /* base create function           */
    {0, 0, 799, 479}                         /* widget size                    */
};
GX_PROMPT_PROPERTIES parent_screen_prompt_properties =
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET parent_screen_prompt_6_define =
{
    "prompt_6",
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(PARENT_SCREEN_CONTROL_BLOCK, parent_screen_prompt_6), /* control block */
    (void *) &parent_screen_prompt_6_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET parent_screen_prompt_define =
{
    "prompt",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(PARENT_SCREEN_CONTROL_BLOCK, parent_screen_prompt), /* control block */
    (void *) &parent_screen_prompt_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET parent_screen_derived_1_define =
{
    "derived_1",
    ...
    {0, 0, 799, 479},                        /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &parent_screen_prompt_define,            /* child widget definition        */
    offsetof(PARENT_SCREEN_CONTROL_BLOCK, parent_screen_derived_1), /* control block */
    (void *) &parent_screen_derived_1_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET parent_screen_derived_define =
{
    "derived",
    GX_TYPE_TEMPLATE,                        /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* event function override        */
    {0, 0, 799, 479},                        /* widget size                    */
    &parent_screen_derived_1_define,         /* next widget definition         */
    &parent_screen_prompt_6_define,          /* child widget definition        */
    offsetof(PARENT_SCREEN_CONTROL_BLOCK, parent_screen_derived), /* control block */
    (void *) &parent_screen_derived_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET parent_screen_define =
{
    "parent_screen",
    GX_TYPE_WINDOW,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED,   /* style flags                    */
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(PARENT_SCREEN_CONTROL_BLOCK),     /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
    GX_COLOR_ID_DISABLED_FILL,               /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    ...
    {0, 0, 799, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &parent_screen_derived_define,           /* child widget                   */
    0,                                       /* control block                  */
    (void *) &parent_screen_properties       /* extended properties            */
};
GX_WINDOW_PROPERTIES window_1_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_WINDOW_PROPERTIES window_1_window_1_properties =
{
...
GX_ICON_PROPERTIES window_1_icon_1_properties =
{
    GX_PIXELMAP_ID_GENERIC_16BPP_PALETTE_ALPHA_DITHER_APPLE, /* normal pixelmap id */
    0                                        /* selected pixelmap id           */
};
GX_RADIO_BUTTON_PROPERTIES window_1_radio_button_1_properties =
{
...
GX_PIXELMAP_PROMPT_PROPERTIES window_1_prompt_1_properties =
{
...
GX_PROMPT_PROPERTIES window_1_prompt_2_properties =
{
...
GX_CHAR window_1_text_input_1_buffer[100];
GX_SINGLE_LINE_TEXT_INPUT_PROPERTIES window_1_text_input_1_properties =
{
    ...
    window_1_text_input_1_buffer,            /* buffer                         */
    100,                                     /* buffer size                    */
};
GX_ML_TEXT_VIEW_PROPERTIES window_1_text_view_1_properties =
{
...
GX_CHAR window_1_text_input_2_buffer[100];
GX_MULTI_LINE_TEXT_INPUT_PROPERTIES window_1_text_input_2_properties =
{
    ...
    0,                                       /* whitespace                     */
    0,                                       /* line_space                     */
    window_1_text_input_2_buffer,            /* buffer                         */
    100                                      /* buffer size                    */
};
...
GX_ML_TEXT_BUTTON_PROPERTIES window_1_multi_line_button_1_properties =
{
...
GX_CHECKBOX_PROPERTIES window_1_checkbox_1_properties =
{
...
GX_ICON_BUTTON_PROPERTIES window_1_icon_button_1_properties =
{
    GX_PIXELMAP_ID_GENERIC_16BPP_565RGB_RAW_SAVE  /* pixelmap id               */
};
GX_VERTICAL_LIST_PROPERTIES window_1_vertical_list_1_properties =
{
    0,                                       /* wallpaper id                   */
    callback_name,                           /* callback function              */
    10                                       /* total rows                     */
};
GX_TEXT_BUTTON_PROPERTIES window_1_button_3_properties =
{
...
GX_HORIZONTAL_LIST_PROPERTIES window_1_horizontal_list_1_properties =
{
    0,                                       /* wallpaper id                   */
    callback_name,                           /* callback function              */
    10                                       /* total columns                  */
};
GX_PROMPT_PROPERTIES window_1_prompt_3_properties =
{
...
GX_ICON_PROPERTIES window_1_icon_2_properties =
{
    GX_PIXELMAP_ID_GENERIC_16BPP_4444ARGB_ALPHA_PATIENT, /* normal pixelmap id */
    0                                        /* selected pixelmap id           */
};
GX_DROP_LIST_PROPERTIES window_1_drop_list_1_properties =
{
...
GX_ICON_BUTTON_PROPERTIES window_1_icon_button_properties =
{
    GX_PIXELMAP_ID_GENERIC_16BPP_565RGB_RAW_SAVE  /* pixelmap id               */
};
GX_SLIDER_PROPERTIES window_1_slider_1_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    100,                                     /* maximum value                  */
...
GX_PIXELMAP_SLIDER_PROPERTIES window_1_pixelmap_slider_1_properties =
{
    0,                                       /* minimum value                  */
    100,                                     /* maximum value                  */
    70,                                      /* current value                  */
...
GX_PROGRESS_BAR_INFO window_1_progress_bar_1_properties =
{
    0,                                       /* mimimun value                  */
    100,                                     /* maximum value                  */
    50,                                      /* current value                  */
...
GX_PIXELMAP_SLIDER_PROPERTIES window_1_pixelmap_slider_2_properties =
{
    0,                                       /* minimum value                  */
    100,                                     /* maximum value                  */
    50,                                      /* current value                  */
...
GX_SCROLLBAR_APPEARANCE  window_1_hscroll_1_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_SCROLLBAR_APPEARANCE  window_1_vertical_scroll_1_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_SPRITE_FRAME window_1_sprite_1_frame_list[2] =
{
    {
...
GX_SPRITE_PROPERTIES window_1_sprite_1_properties =
{
    window_1_sprite_1_frame_list,            /* address of frame list          */
    2,                                       /* frame count                    */
};
GX_CIRCULAR_GAUGE_PROPERTIES window_1_gauge_1_properties =
{
    0,                                       /* start angle                    */
    30,                                      /* animation steps                */
    1,                                       /* animation delay                */
...
GX_PROMPT_PROPERTIES window_1_prompt_4_properties =
{
...
GX_PROMPT_PROPERTIES window_1_prompt_5_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES window_1_radio_button_2_properties =
{
...
GX_CHECKBOX_PROPERTIES window_1_checkbox_2_properties =
{
    GX_STRING_ID_GENERIC_16BPP_STRING_12,    /* string id                      */
    GX_FONT_ID_BUTTON,                       /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET window_1_button_4_define =
{
    "button_4",
    GX_TYPE_BUTTON,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_button_4), /* control block      */
    (void *) GX_NULL                         /* no extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window_1_button_3_define =
{
    "button_3",
    ...
    &window_1_button_4_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_button_3), /* control block      */
    (void *) &window_1_button_3_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_icon_2_define =
{
    "icon_2",
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_icon_2), /* control block        */
    (void *) &window_1_icon_2_properties     /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_prompt_3_define =
{
    "prompt_3",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_icon_2_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_prompt_3), /* control block      */
    (void *) &window_1_prompt_3_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_button_5_define =
{
    "button_5",
    GX_TYPE_BUTTON,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_prompt_3_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_button_5), /* control block      */
    (void *) GX_NULL                         /* no extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window_1_icon_button_define =
{
    "icon_button",
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_icon_button), /* control block   */
    (void *) &window_1_icon_button_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window_1_checkbox_2_define =
{
    "checkbox_2",
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_checkbox_2), /* control block    */
    (void *) &window_1_checkbox_2_properties /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_radio_button_2_define =
{
    "radio_button_2",
    ...
    &window_1_checkbox_2_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_radio_button_2), /* control block */
    (void *) &window_1_radio_button_2_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_1_prompt_5_define =
{
    "prompt_5",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_radio_button_2_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_prompt_5), /* control block      */
    (void *) &window_1_prompt_5_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_prompt_4_define =
{
    "prompt_4",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_prompt_5_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_prompt_4), /* control block      */
    (void *) &window_1_prompt_4_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_gauge_1_define =
{
    "gauge_1",
    ...
    &window_1_prompt_4_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_gauge_1), /* control block       */
    (void *) &window_1_gauge_1_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_sprite_1_define =
{
    "sprite_1",
    ...
    &window_1_gauge_1_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_sprite_1), /* control block      */
    (void *) &window_1_sprite_1_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_vertical_scroll_1_define =
{
    "vertical_scroll_1",
    ...
    &window_1_sprite_1_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_vertical_scroll_1), /* control block */
    (void *) &window_1_vertical_scroll_1_properties /* extended properties     */
};

GX_CONST GX_STUDIO_WIDGET window_1_hscroll_1_define =
{
    "hscroll_1",
    ...
    &window_1_vertical_scroll_1_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_hscroll_1), /* control block     */
    (void *) &window_1_hscroll_1_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_pixelmap_slider_2_define =
{
    "pixelmap_slider_2",
    ...
    &window_1_hscroll_1_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_pixelmap_slider_2), /* control block */
    (void *) &window_1_pixelmap_slider_2_properties /* extended properties     */
};

GX_CONST GX_STUDIO_WIDGET window_1_progress_bar_1_define =
{
    "progress_bar_1",
    ...
    &window_1_pixelmap_slider_2_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_progress_bar_1), /* control block */
    (void *) &window_1_progress_bar_1_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_1_pixelmap_slider_1_define =
{
    "pixelmap_slider_1",
    GX_TYPE_PIXELMAP_SLIDER,                 /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_progress_bar_1_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_pixelmap_slider_1), /* control block */
    (void *) &window_1_pixelmap_slider_1_properties /* extended properties     */
};

GX_CONST GX_STUDIO_WIDGET window_1_slider_1_define =
{
    "slider_1",
    ...
    &window_1_pixelmap_slider_1_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_slider_1), /* control block      */
    (void *) &window_1_slider_1_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_drop_list_1_define =
{
    "drop_list_1",
    ...
    &window_1_slider_1_define,               /* next widget definition         */
    &window_1_icon_button_define,            /* child widget definition        */
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_drop_list_1), /* control block   */
    (void *) &window_1_drop_list_1_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window_1_horizontal_list_1_define =
{
    "horizontal_list_1",
    ...
    &window_1_drop_list_1_define,            /* next widget definition         */
    &window_1_button_5_define,               /* child widget definition        */
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_horizontal_list_1), /* control block */
    (void *) &window_1_horizontal_list_1_properties /* extended properties     */
};

GX_CONST GX_STUDIO_WIDGET window_1_vertical_list_1_define =
{
    "vertical_list_1",
    ...
    &window_1_horizontal_list_1_define,      /* next widget definition         */
    &window_1_button_3_define,               /* child widget definition        */
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_vertical_list_1), /* control block */
    (void *) &window_1_vertical_list_1_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET window_1_icon_button_1_define =
{
    "icon_button_1",
    GX_TYPE_ICON_BUTTON,                     /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_vertical_list_1_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_icon_button_1), /* control block */
    (void *) &window_1_icon_button_1_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window_1_checkbox_1_define =
{
    "checkbox_1",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_icon_button_1_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_checkbox_1), /* control block    */
    (void *) &window_1_checkbox_1_properties /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_multi_line_button_1_define =
{
    "multi_line_button_1",
    ...
    &window_1_checkbox_1_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_multi_line_button_1), /* control block */
    (void *) &window_1_multi_line_button_1_properties /* extended properties   */
};
...
GX_CONST GX_STUDIO_WIDGET window_1_button_1_define =
{
    ...
    &window_1_button_2_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_button_1), /* control block      */
    (void *) GX_NULL                         /* no extended properties         */
};

GX_CONST GX_STUDIO_WIDGET window_1_text_input_2_define =
{
    "text_input_2",
    ...
    &window_1_button_1_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_text_input_2), /* control block  */
    (void *) &window_1_text_input_2_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET window_1_text_view_1_define =
{
    "text_view_1",
    ...
    &window_1_text_input_2_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_text_view_1), /* control block   */
    (void *) &window_1_text_view_1_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window_1_text_input_1_define =
{
    "text_input_1",
    ...
    &window_1_text_view_1_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_text_input_1), /* control block  */
    (void *) &window_1_text_input_1_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET window_1_prompt_2_define =
{
    "prompt_2",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_text_input_1_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_prompt_2), /* control block      */
    (void *) &window_1_prompt_2_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_prompt_1_define =
{
    "prompt_1",
    ...
    &window_1_prompt_2_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_prompt_1), /* control block      */
    (void *) &window_1_prompt_1_properties   /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_1_radio_button_1_define =
{
    "radio_button_1",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_prompt_1_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_radio_button_1), /* control block */
    (void *) &window_1_radio_button_1_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_1_icon_1_define =
{
    "icon_1",
    GX_TYPE_ICON,                            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &window_1_radio_button_1_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_icon_1), /* control block        */
    (void *) &window_1_icon_1_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_1_pixelmap_button_1_define =
{
    ...
    &window_1_icon_1_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_1_window_1_define =
{
    "window_1",
    GX_TYPE_WINDOW,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_1_CONTROL_BLOCK, window_1_window_1), /* control block      */
    (void *) &window_1_window_1_properties   /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_1_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window_1_window_1_define,               /* child widget                   */
    0,                                       /* control block                  */
...
GX_PIXELMAP_PROMPT_PROPERTIES window_prompt_properties =
{
    GX_STRING_ID_GENERIC_16BPP_STRING_6,     /* string id                      */
    GX_FONT_ID_GENERIC_16BPP_FONT_4BPP,      /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CHAR window_text_input_buffer[100];
GX_MULTI_LINE_TEXT_INPUT_PROPERTIES window_text_input_properties =
{
    GX_STRING_ID_GENERIC_16BPP_STRING_10,    /* string id                      */
    GX_FONT_ID_TEXT_INPUT,                   /* font id                        */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal text color              */
    ...
    0,                                       /* whitespace                     */
    0,                                       /* line_space                     */
    window_text_input_buffer,                /* buffer                         */
    100                                      /* buffer size                    */
};
...
GX_CONST GX_STUDIO_WIDGET window_text_input_define =
{
    "text_input",
    GX_TYPE_MULTI_LINE_TEXT_INPUT,           /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {605, 167, 696, 248},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_text_input), /* control block        */
    (void *) &window_text_input_properties   /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {409, 32, 588, 180},                     /* widget size                    */
    &window_text_input_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_checkbox_2_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {318, 416, 421, 439},                    /* widget size                    */
    &window_window_define,                   /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY test_copy_paste_widget_table[] =
{
    { &parent_screen_define, (GX_WIDGET *) &parent_screen },
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = test_copy_paste_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &test_copy_paste_display_table[display];
