...
/*  Date (dd.mm.yyyy): 15.11.2021   Time (hh:mm): 14:00                        */
/*******************************************************************************/


#define GUIX_STUDIO_GENERATED_FILE
#include <stddef.h>
#include "test_sprite_resources.h"
#include "test_sprite_specifications.h"
...
GX_STUDIO_DISPLAY_INFO test_sprite_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_SPRITE_FRAME window_sprite_frame_list[3] =
{
    {
    ...
    {
        GX_PIXELMAP_ID_SPRITE_FISH,          /* pixelmap id                    */
        0,                                   /* x offset                       */
        0,                                   /* y offset                       */
        5,                                   /* frame delay                    */
        GX_SPRITE_BACKGROUND_NO_ACTION,      /* background operation           */
...
GX_SPRITE_PROPERTIES window_sprite_properties =
{
    window_sprite_frame_list,                /* address of frame list          */
    3,                                       /* frame count                    */
};
GX_SPRITE_FRAME window_sprite_1_frame_list[4] =
{
    {
...
GX_SPRITE_FRAME window_sprite_2_frame_list[4] =
{
    {
        GX_PIXELMAP_ID_FRAME_000,            /* pixelmap id                    */
        5,                                   /* x offset                       */
...
GX_SPRITE_PROPERTIES window_sprite_2_properties =
{
    window_sprite_2_frame_list,              /* address of frame list          */
    4,                                       /* frame count                    */
};

GX_CONST GX_STUDIO_WIDGET window_sprite_2_define =
{
    "sprite_2",
    ...
    {0, 0, 63, 63},                          /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_sprite_2), /* control block          */
    (void *) &window_sprite_2_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_sprite_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {25, 154, 124, 233},                     /* widget size                    */
    &window_sprite_2_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_sprite_1), /* control block          */
    (void *) &window_sprite_1_properties     /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_sprite_define =
{
    "sprite",
    GX_TYPE_SPRITE,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {128, 88, 191, 151},                     /* widget size                    */
    &window_sprite_1_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_sprite), /* control block            */
    (void *) &window_sprite_properties       /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window_sprite_define,                   /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY test_sprite_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = test_sprite_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &test_sprite_display_table[display];
