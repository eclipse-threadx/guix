...
#include "test_font_specifications.h"

static GX_WIDGET *gx_studio_nested_widget_create(GX_BYTE *control, GX_CONST GX_STUDIO_WIDGET *definition, GX_WIDGET *parent);
FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK Font_kerning_test_window;
...
GX_STUDIO_DISPLAY_INFO test_font_display_table[1] =
{
    {
    "main_display",
    "main_display_canvas",
...
GX_WINDOW_PROPERTIES Font_kerning_test_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_7_properties =
{
...
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_8_properties =
{
    GX_STRING_ID_STRING_10,                  /* string id                      */
    GX_FONT_ID_FONT_8BIT_KERNING,            /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_9_properties =
{
...
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_10_properties =
{
    GX_STRING_ID_STRING_12,                  /* string id                      */
    GX_FONT_ID_FONT_4BIT_KERNING,            /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_11_properties =
{
...
GX_PROMPT_PROPERTIES Font_kerning_test_window_prompt_12_properties =
{
    GX_STRING_ID_STRING_14,                  /* string id                      */
    GX_FONT_ID_FONT_1BIT_KERNING,            /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_12_define =
{
    "prompt_12",
    ...
    {0, 460, 639, 479},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_12), /* control block */
    (void *) &Font_kerning_test_window_prompt_12_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_11_define =
{
    "prompt_11",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 440, 639, 459},                      /* widget size                    */
    &Font_kerning_test_window_prompt_12_define, /* next widget definition      */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_11), /* control block */
    (void *) &Font_kerning_test_window_prompt_11_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_10_define =
{
    "prompt_10",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 380, 639, 439},                      /* widget size                    */
    &Font_kerning_test_window_prompt_11_define, /* next widget definition      */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_10), /* control block */
    (void *) &Font_kerning_test_window_prompt_10_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_9_define =
{
    "prompt_9",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 320, 639, 379},                      /* widget size                    */
    &Font_kerning_test_window_prompt_10_define, /* next widget definition      */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_9), /* control block */
    (void *) &Font_kerning_test_window_prompt_9_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_8_define =
{
    "prompt_8",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 160, 639, 319},                      /* widget size                    */
    &Font_kerning_test_window_prompt_9_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_8), /* control block */
    (void *) &Font_kerning_test_window_prompt_8_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_prompt_7_define =
{
    "prompt_7",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 0, 639, 159},                        /* widget size                    */
    &Font_kerning_test_window_prompt_8_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK, Font_kerning_test_window_prompt_7), /* control block */
    (void *) &Font_kerning_test_window_prompt_7_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET Font_kerning_test_window_define =
{
    "Font_kerning_test_window",
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(FONT_KERNING_TEST_WINDOW_CONTROL_BLOCK), /* control block size      */
    ...
    GX_NULL,                                 /* next widget                    */
    &Font_kerning_test_window_prompt_7_define, /* child widget                 */
    0,                                       /* control block                  */
    (void *) &Font_kerning_test_window_properties /* extended properties       */
};
...
GX_PROMPT_PROPERTIES main_window_prompt_properties =
{
    ...
    GX_FONT_ID_FONT_1BIT_RAW,                /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES main_window_prompt_1_properties =
{
    ...
    GX_FONT_ID_FONT_1BIT_COMPRESSED,         /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES main_window_prompt_2_properties =
{
    ...
    GX_FONT_ID_FONT_4BIT_RAW,                /* font id                        */
...
GX_PROMPT_PROPERTIES main_window_prompt_3_properties =
{
    ...
    GX_FONT_ID_FONT_4BIT_COMPRESSED,         /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES main_window_prompt_4_properties =
{
    ...
    GX_FONT_ID_FONT_8BIT_RAW,                /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES main_window_prompt_5_properties =
{
    ...
    GX_FONT_ID_FONT_8BIT_COMPRESSED,         /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_PROMPT_PROPERTIES main_window_prompt_6_properties =
{
    ...
    GX_FONT_ID_FONT_OLD_ITALIC,              /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
...
GX_CONST GX_STUDIO_WIDGET_ENTRY test_font_widget_table[] =
{
    { &Font_kerning_test_window_define, (GX_WIDGET *) &Font_kerning_test_window },
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = test_font_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &test_font_display_table[display];
