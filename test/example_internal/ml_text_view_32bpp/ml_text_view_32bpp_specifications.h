...
#ifndef _ML_TEXT_VIEW_32BPP_SPECIFICATIONS_H_
#define _ML_TEXT_VIEW_32BPP_SPECIFICATIONS_H_
...
typedef struct WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_RADIO_BUTTON window_font_1bpp_1;
    GX_RADIO_BUTTON window_font_1bpp_2;
