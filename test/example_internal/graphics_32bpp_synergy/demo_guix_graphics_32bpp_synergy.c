...
GX_RESOURCE_ID    pixelmap_id[4] = {GX_PIXELMAP_ID_PIXELMAP_RAW, GX_PIXELMAP_ID_PIXELMAP_ALPHA, GX_PIXELMAP_ID_PIXELMAP_COMPRESSED, GX_PIXELMAP_ID_PIXELMAP_COMPRESSED_ALPHA };
#define CIRCLE    0
#define ARC       1
#define PIE       2
#define POLYGON   3
...
static GX_CHAR str_buf[10];
    ...
    if(pp)
    {
        ...
        str.gx_string_length = string_length_get(str_buf, sizeof(str_buf) - 1);
...
GX_POINT self_intersection[8] = {{110, 326}, {189, 420}, {266, 326}, {334, 420}, {334, 326}, {264, 420}, {189, 326}, {110, 420}};
    ...
    if(pixelmap_fill)
    {
        ...
        gx_context_pixelmap_set(pixelmap_id[compress + alpha]);
    }
