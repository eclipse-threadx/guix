...
SECOND_SCREEN_CONTROL_BLOCK second_screen;
...
GX_STUDIO_DISPLAY_INFO bidi_text_line_break_static_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_ML_TEXT_VIEW_PROPERTIES ml_view_base_properties =
{
    GX_STRING_ID_ARABIC_ML_VIEW_BASE,        /* string id                      */
...
GX_SCROLLBAR_APPEARANCE  ml_view_base_vertical_scroll_1_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_CONST GX_STUDIO_WIDGET ml_view_base_vertical_scroll_1_define =
{
    "vertical_scroll_1",
    ...
    {490, 71, 509, 430},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(ML_VIEW_BASE_CONTROL_BLOCK, ml_view_base_vertical_scroll_1), /* control block */
    (void *) &ml_view_base_vertical_scroll_1_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET ml_view_base_define =
{
    "ml_view_base",
    ...
    sizeof(ML_VIEW_BASE_CONTROL_BLOCK),      /* control block size             */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {205, 70, 617, 255},                     /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &ml_view_base_vertical_scroll_1_define,  /* child widget                   */
    0,                                       /* control block                  */
    (void *) &ml_view_base_properties        /* extended properties            */
};
GX_WINDOW_PROPERTIES second_screen_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_ML_TEXT_VIEW_PROPERTIES second_screen_ml_view_Arabic_1_properties =
{
    GX_STRING_ID_ARABIC_ML_VIEW_ARABIC_1,    /* string id                      */
    GX_FONT_ID_ARABIC,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_TEXT,                        /* selected text color            */
    GX_COLOR_ID_TEXT,                        /* disabled text color            */
...
GX_SCROLLBAR_APPEARANCE  second_screen_vertical_scroll_1_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_TEMPLATE_PROPERTIES second_screen_ml_view_derived_properties =
{
    &ml_view_base_define,                    /* base info                      */
    gx_studio_multi_line_text_view_create,   /* base create function           */
    {29, 249, 441, 434}                      /* widget size                    */
};

GX_CONST GX_STUDIO_WIDGET second_screen_vertical_scroll_1_define =
{
    "vertical_scroll_1",
    GX_TYPE_VERTICAL_SCROLL,                 /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {315, 30, 334, 389},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(SECOND_SCREEN_CONTROL_BLOCK, second_screen_vertical_scroll_1), /* control block */
    (void *) &second_screen_vertical_scroll_1_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET second_screen_ml_view_derived_define =
{
    "ml_view_derived",
    ...
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(SECOND_SCREEN_CONTROL_BLOCK, second_screen_ml_view_derived), /* control block */
    (void *) &second_screen_ml_view_derived_properties /* extended properties  */
};

GX_CONST GX_STUDIO_WIDGET second_screen_ml_view_Arabic_1_define =
{
    "ml_view_Arabic_1",
    GX_TYPE_MULTI_LINE_TEXT_VIEW,            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {30, 29, 618, 214},                      /* widget size                    */
    &second_screen_ml_view_derived_define,   /* next widget definition         */
    &second_screen_vertical_scroll_1_define, /* child widget definition        */
    offsetof(SECOND_SCREEN_CONTROL_BLOCK, second_screen_ml_view_Arabic_1), /* control block */
    (void *) &second_screen_ml_view_Arabic_1_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET second_screen_define =
{
    "second_screen",
    ...
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED,   /* style flags                    */
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(SECOND_SCREEN_CONTROL_BLOCK),     /* control block size             */
    ...
    GX_NULL,                                 /* next widget                    */
    &second_screen_ml_view_Arabic_1_define,  /* child widget                   */
    0,                                       /* control block                  */
    (void *) &second_screen_properties       /* extended properties            */
};
GX_WINDOW_PROPERTIES main_screen_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_ML_TEXT_VIEW_PROPERTIES main_screen_ml_view_Hebrew_properties =
{
...
{
    GX_STRING_ID_HEBREW_2,                   /* string id                      */
    GX_FONT_ID_HEBREW,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_DISABLED_TEXT                /* disabled text color            */
};
GX_ML_TEXT_VIEW_PROPERTIES main_screen_ml_view_Arabic_properties =
{
    GX_STRING_ID_ARABIC_ML_VIEW_ARABIC,      /* string id                      */
    GX_FONT_ID_ARABIC,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_TEXT,                        /* selected text color            */
    GX_COLOR_ID_TEXT,                        /* disabled text color            */
...
GX_ML_TEXT_VIEW_PROPERTIES main_screen_ml_view_English_properties =
{
...
{
    GX_STRING_ID_ENGLISH_2,                  /* string id                      */
...
GX_CONST GX_STUDIO_WIDGET main_screen_ml_view_English_define =
{
    "ml_view_English",
    GX_TYPE_MULTI_LINE_TEXT_VIEW,            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {79, 259, 264, 358},                     /* widget size                    */
    &main_screen_prompt_1_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_ml_view_English), /* control block */
    (void *) &main_screen_ml_view_English_properties /* extended properties    */
};

GX_CONST GX_STUDIO_WIDGET main_screen_ml_view_Arabic_define =
{
    "ml_view_Arabic",
    GX_TYPE_MULTI_LINE_TEXT_VIEW,            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    &main_screen_ml_view_English_define,     /* next widget definition         */
    &main_screen_vertical_scroll_define,     /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_ml_view_Arabic), /* control block */
    (void *) &main_screen_ml_view_Arabic_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_define =
{
    ...
    &main_screen_ml_view_Arabic_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_ml_view_Hebrew_define =
{
    "ml_view_Hebrew",
    GX_TYPE_MULTI_LINE_TEXT_VIEW,            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {80, 83, 265, 202},                      /* widget size                    */
    &main_screen_prompt_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_ml_view_Hebrew), /* control block */
    (void *) &main_screen_ml_view_Hebrew_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    {0, 0, 639, 479},                        /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &main_screen_ml_view_Hebrew_define,      /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_screen_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY bidi_text_line_break_static_widget_table[] =
{
    { &second_screen_define, (GX_WIDGET *) &second_screen },
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = bidi_text_line_break_static_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &bidi_text_line_break_static_display_table[display];
