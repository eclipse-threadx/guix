...
extern GX_STUDIO_DISPLAY_INFO all_widgets_execute_display_table[];
...
VOID start_guix(void)
{
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_execute_display_table[0].display,
        GX_CANVAS_COMPOSITE,
...
UINT window_screen_event_process(GX_WINDOW *window, GX_EVENT *event_ptr)
{
    switch(event_ptr->gx_event_type)
    {
    case GX_EVENT_SHOW:
