...
extern GX_STUDIO_DISPLAY_INFO all_widgets_16bpp_rotated_270_display_table[];
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    gx_multi_line_text_input_text_set(&widget_color_test_screen.widget_color_test_screen_ml_text_input, "multi line text input");
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_16bpp_rotated_270_display_table[0].display,
        GX_CANVAS_COMPOSITE,
