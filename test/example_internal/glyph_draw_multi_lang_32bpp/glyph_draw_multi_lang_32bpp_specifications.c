...
GX_STUDIO_DISPLAY_INFO glyph_draw_multi_lang_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_PROMPT_PROPERTIES window_prompt__3_properties =
{
...
GX_PROMPT_PROPERTIES window_prompt__4_properties =
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
...
GX_PROMPT_PROPERTIES window_prompt__5_properties =
{
    GX_STRING_ID_STRING_4,                   /* string id                      */
    GX_FONT_ID_CHINESE_4BIT,                 /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES window_prompt__6_properties =
{
    GX_STRING_ID_STRING_4,                   /* string id                      */
    GX_FONT_ID_CHINESE_1BIT,                 /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET window_prompt__6_define =
{
    "prompt__6",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {97, 176, 164, 201},                     /* widget size                    */
    &window_prompt_1_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt__6), /* control block         */
    (void *) &window_prompt__6_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_prompt__5_define =
{
    "prompt__5",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {97, 113, 164, 138},                     /* widget size                    */
    &window_prompt__6_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt__5), /* control block         */
    (void *) &window_prompt__5_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_prompt__4_define =
{
    "prompt__4",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {40, 176, 81, 201},                      /* widget size                    */
    &window_prompt__5_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt__4), /* control block         */
    (void *) &window_prompt__4_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt__2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {40, 113, 81, 138},                      /* widget size                    */
    &window_prompt__4_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_prompt__3_define =
{
    "prompt__3",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {97, 50, 164, 75},                       /* widget size                    */
    &window_prompt__1_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt__3), /* control block         */
    (void *) &window_prompt__3_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_6_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {34, 84, 113, 107},                      /* widget size                    */
    &window_prompt__3_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {12, 11, 305, 225},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_prompt_2_define,                 /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY glyph_draw_multi_lang_32bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = glyph_draw_multi_lang_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &glyph_draw_multi_lang_32bpp_display_table[display];
