...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(demo_guix_smart_watch_display_table[0].display, props->string_id, &text);
...
GX_PROMPT_PROPERTIES weather_LosAngeles_hi_properties =
{
...
GX_PROMPT_PROPERTIES weather_LosAngeles_low_properties =
{
...
GX_PROMPT_PROPERTIES weather_LosAngeles_hi_T_properties =
{
...
GX_PROMPT_PROPERTIES weather_LosAngeles_low_T_properties =
{
...
GX_CONST GX_STUDIO_WIDGET weather_LosAngeles_low_T_define =
{
    "low_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {182, 162, 203, 179},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_LOSANGELES_CONTROL_BLOCK, weather_LosAngeles_low_T), /* control block */
    (void *) &weather_LosAngeles_low_T_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET weather_LosAngeles_hi_T_define =
{
    "hi_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {124, 162, 145, 179},                    /* widget size                    */
    &weather_LosAngeles_low_T_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_LOSANGELES_CONTROL_BLOCK, weather_LosAngeles_hi_T), /* control block */
    (void *) &weather_LosAngeles_hi_T_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET weather_LosAngeles_low_define =
{
    "low",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {149, 161, 180, 178},                    /* widget size                    */
    &weather_LosAngeles_hi_T_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_LOSANGELES_CONTROL_BLOCK, weather_LosAngeles_low), /* control block */
    (void *) &weather_LosAngeles_low_properties /* extended properties         */
};

GX_CONST GX_STUDIO_WIDGET weather_LosAngeles_hi_define =
{
    "hi",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {86, 161, 122, 178},                     /* widget size                    */
    &weather_LosAngeles_low_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_LOSANGELES_CONTROL_BLOCK, weather_LosAngeles_hi), /* control block */
    (void *) &weather_LosAngeles_hi_properties /* extended properties          */
};
...
GX_CONST GX_STUDIO_WIDGET weather_LosAngeles_prompt_14_2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {195, 92, 212, 122},                     /* widget size                    */
    &weather_LosAngeles_hi_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_PROMPT_PROPERTIES weather_SanFrancisco_hi_properties =
{
    GX_STRING_ID_STRING_5,                   /* string id                      */
    GX_FONT_ID_SMALL,                        /* font id                        */
    GX_COLOR_ID_GRAY,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES weather_SanFrancisco_low_properties =
{
    GX_STRING_ID_STRING_6,                   /* string id                      */
    GX_FONT_ID_SMALL,                        /* font id                        */
    GX_COLOR_ID_GRAY,                        /* normal text color              */
...
GX_PROMPT_PROPERTIES weather_SanFrancisco_hi_T_properties =
{
...
GX_PROMPT_PROPERTIES weather_SanFrancisco_low_T_properties =
{
...
GX_CONST GX_STUDIO_WIDGET weather_SanFrancisco_low_T_define =
{
    "low_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {181, 163, 202, 180},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SANFRANCISCO_CONTROL_BLOCK, weather_SanFrancisco_low_T), /* control block */
    (void *) &weather_SanFrancisco_low_T_properties /* extended properties     */
};

GX_CONST GX_STUDIO_WIDGET weather_SanFrancisco_hi_T_define =
{
    "hi_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {123, 163, 144, 180},                    /* widget size                    */
    &weather_SanFrancisco_low_T_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SANFRANCISCO_CONTROL_BLOCK, weather_SanFrancisco_hi_T), /* control block */
    (void *) &weather_SanFrancisco_hi_T_properties /* extended properties      */
};

GX_CONST GX_STUDIO_WIDGET weather_SanFrancisco_low_define =
{
    "low",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {148, 162, 179, 179},                    /* widget size                    */
    &weather_SanFrancisco_hi_T_define,       /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SANFRANCISCO_CONTROL_BLOCK, weather_SanFrancisco_low), /* control block */
    (void *) &weather_SanFrancisco_low_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET weather_SanFrancisco_hi_define =
{
    "hi",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {85, 162, 119, 179},                     /* widget size                    */
    &weather_SanFrancisco_low_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SANFRANCISCO_CONTROL_BLOCK, weather_SanFrancisco_hi), /* control block */
    (void *) &weather_SanFrancisco_hi_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET weather_SanFrancisco_prompt_14_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {194, 93, 211, 123},                     /* widget size                    */
    &weather_SanFrancisco_hi_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
{
    GX_STRING_ID_LAST_NAME,                  /* string id                      */
    GX_FONT_ID_SMALL,                        /* font id                        */
    GX_COLOR_ID_GRAY,                        /* normal text color              */
    GX_COLOR_ID_GRAY,                        /* selected text color            */
    GX_COLOR_ID_GRAY                         /* disabled text color            */
...
GX_PROMPT_PROPERTIES weather_screen_hi_T_properties =
{
    GX_STRING_ID_STRING_7,                   /* string id                      */
    GX_FONT_ID_SYSTEM,                       /* font id                        */
    GX_COLOR_ID_LIGHT_GRAY,                  /* normal text color              */
...
GX_PROMPT_PROPERTIES weather_screen_low_T_properties =
{
    GX_STRING_ID_STRING_8,                   /* string id                      */
    GX_FONT_ID_SYSTEM,                       /* font id                        */
    GX_COLOR_ID_LIGHT_GRAY,                  /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET weather_screen_low_T_define =
{
    "low_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {182, 163, 203, 180},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SCREEN_CONTROL_BLOCK, weather_screen_low_T), /* control block */
    (void *) &weather_screen_low_T_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET weather_screen_hi_T_define =
{
    "hi_T",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {124, 163, 145, 180},                    /* widget size                    */
    &weather_screen_low_T_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WEATHER_SCREEN_CONTROL_BLOCK, weather_screen_hi_T), /* control block */
    (void *) &weather_screen_hi_T_properties /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET weather_screen_low_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {149, 162, 180, 179},                    /* widget size                    */
    &weather_screen_hi_T_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET calculator_screen_calculator_7_define =
{
    ...
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_HALIGN_CENTER|GX_STYLE_VALIGN_CENTER,   /* style flags */
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(GX_PIXELMAP_BUTTON),              /* control block size             */
    GX_COLOR_ID_WHITE,                       /* normal color id                */
    GX_COLOR_ID_BLUE,                        /* selected color id              */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY demo_guix_smart_watch_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = demo_guix_smart_watch_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &demo_guix_smart_watch_display_table[display];
