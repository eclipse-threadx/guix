...
/*  Date (dd.mm.yyyy): 20. 4.2023   Time (hh:mm): 16:51                        */
/*******************************************************************************/
...
GX_STUDIO_DISPLAY_INFO color_convert_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CHECKBOX_PROPERTIES window_compress_properties =
{
...
GX_WINDOW_PROPERTIES window_alphamap_window_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
...
GX_RADIO_BUTTON_PROPERTIES window_radio_button_jpg_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES window_radio_button_png_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_radio_button_png_define =
{
    "radio_button_png",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_PNG_RADIO_BTN,                        /* widget id                      */
    ...
    {284, 182, 363, 205},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_radio_button_png), /* control block  */
    (void *) &window_radio_button_png_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET window_radio_button_jpg_define =
{
    "radio_button_jpg",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_JPG_RADIO_BTN,                        /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {284, 149, 363, 172},                    /* widget size                    */
    &window_radio_button_png_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_radio_button_jpg), /* control block  */
    (void *) &window_radio_button_jpg_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET window_window_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {278, 125, 374, 244},                    /* widget size                    */
    &window_prompt_2_define,                 /* next widget definition         */
    &window_radio_button_jpg_define,         /* child widget definition        */
...
GX_CONST GX_STUDIO_WIDGET window_alphamap_window_define =
{
    "alphamap_window",
    GX_TYPE_WINDOW,                          /* widget type                    */
    ID_ALPHAMAP_WINDOW,                      /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_COLOR_ID_WINDOW_FILL,                 /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) alphamap_draw,   /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {376, 81, 605, 370},                     /* widget size                    */
    &window_checkbox_1_define,               /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_alphamap_window), /* control block   */
    (void *) &window_alphamap_window_properties /* extended properties         */
};
...
GX_CONST GX_STUDIO_WIDGET window_pixelmap_window_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {31, 81, 260, 370},                      /* widget size                    */
    &window_alphamap_window_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_compress_define =
{
    "compress",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_COMPRESS_CHECK,                       /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_PUSHED|GX_STYLE_BUTTON_TOGGLE|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {277, 396, 396, 419},                    /* widget size                    */
    &window_pixelmap_window_define,          /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_compress), /* control block          */
    (void *) &window_compress_properties     /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window_compress_define,                 /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY color_convert_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = color_convert_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &color_convert_16bpp_display_table[display];
