...
#ifndef _SPRITE_16BPP_SPECIFICATIONS_H_
#define _SPRITE_16BPP_SPECIFICATIONS_H_
...
#define ID_ALPHA_SLIDER 1
#define ID_ALPHA_DISPLAY 2
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_WINDOW main_window_AppleWindow;
    GX_PROMPT main_window_alpha_label;
    GX_SLIDER main_window_alpha_slider;
    GX_PROMPT main_window_alpha_display;
...
VOID AppleWindowDraw(GX_WINDOW *widget);
