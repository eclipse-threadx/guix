...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_5_4_0_resources.h"
#include "all_widgets_5_4_0_specifications.h"
...
extern GX_STUDIO_DISPLAY_INFO all_widgets_5_4_0_display_table[];
...
VOID start_guix(void)
{
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_5_4_0_display_table[0].display,
        GX_CANVAS_COMPOSITE,
