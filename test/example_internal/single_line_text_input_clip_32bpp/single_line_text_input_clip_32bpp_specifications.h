...
#ifndef _SINGLE_LINE_TEXT_INPUT_CLIP_32BPP_SPECIFICATIONS_H_
#define _SINGLE_LINE_TEXT_INPUT_CLIP_32BPP_SPECIFICATIONS_H_
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_SINGLE_LINE_TEXT_INPUT main_window_text_input_1bpp;
    GX_PROMPT main_window_prompt_5;
    GX_SINGLE_LINE_TEXT_INPUT main_window_text_input_4bpp;
    GX_SINGLE_LINE_TEXT_INPUT main_window_text_input_8bpp;
