...
GX_STUDIO_DISPLAY_INFO ml_text_view_vcenter_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
{
    GX_STRING_ID_SHORT_STRING,               /* string id                      */
    GX_FONT_ID_SYSTEM,                       /* font id                        */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal text color              */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* selected text color            */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* disabled text color            */
...
GX_ML_TEXT_VIEW_PROPERTIES main_screen_text_view_3_properties =
{
    GX_STRING_ID_SHORT_STRING,               /* string id                      */
    GX_FONT_ID_SYSTEM,                       /* font id                        */
    GX_COLOR_ID_TEXT_INPUT_TEXT,             /* normal text color              */
...
GX_SCROLLBAR_APPEARANCE  main_screen_vertical_scroll_3_properties =
{
    20,                                      /* scroll width                   */
    18,                                      /* thumb width                    */
    20,                                      /* thumb travel min               */
...
GX_CONST GX_STUDIO_WIDGET main_screen_vertical_scroll_3_define =
{
    "vertical_scroll_3",
    GX_TYPE_VERTICAL_SCROLL,                 /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {485, 255, 504, 450},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_vertical_scroll_3), /* control block */
    (void *) &main_screen_vertical_scroll_3_properties /* extended properties  */
};

GX_CONST GX_STUDIO_WIDGET main_screen_text_view_3_define =
{
    "text_view_3",
    ...
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED|GX_STYLE_TEXT_LEFT|GX_STYLE_VALIGN_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {332, 254, 536, 462},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &main_screen_vertical_scroll_3_define,   /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_text_view_3), /* control block */
    (void *) &main_screen_text_view_3_properties /* extended properties        */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_text_view_2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {30, 251, 234, 459},                     /* widget size                    */
    &main_screen_text_view_3_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY ml_text_view_vcenter_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = ml_text_view_vcenter_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &ml_text_view_vcenter_display_table[display];
