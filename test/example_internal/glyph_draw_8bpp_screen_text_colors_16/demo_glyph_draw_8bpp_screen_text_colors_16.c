...
#include "glyph_draw_8bpp_screen_text_colors_16_resources.h"
#include "glyph_draw_8bpp_screen_text_colors_16_specifications.h"
...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    strcpy(pVSliderInput->gx_single_line_text_input_buffer, "60");
    ...
    strcpy(pVClipInput->gx_single_line_text_input_buffer, "20");
    pVClipInput -> gx_single_line_text_input_string_size = 2;

    strcpy(pHClipInput->gx_single_line_text_input_buffer, "20");
    pHClipInput -> gx_single_line_text_input_string_size = 2;
