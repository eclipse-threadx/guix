...
GX_STUDIO_DISPLAY_INFO glyph_draw_8bpp_screen_text_colors_16_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(glyph_draw_8bpp_screen_text_colors_16_display_table[0].display, props->string_id, &text);
...
GX_CONST GX_STUDIO_WIDGET_ENTRY glyph_draw_8bpp_screen_text_colors_16_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = glyph_draw_8bpp_screen_text_colors_16_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &glyph_draw_8bpp_screen_text_colors_16_display_table[display];
