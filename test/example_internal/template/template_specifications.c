...
GX_CONST GX_STUDIO_WIDGET base_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {377, 160, 456, 183},                    /* widget size                    */
    &base_button_define,                     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(BASE_CONTROL_BLOCK, base_prompt), /* control block                */
...
GX_CONST GX_STUDIO_WIDGET base_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {74, 120, 603, 317},                     /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &base_prompt_define,                     /* child widget                   */
    0,                                       /* control block                  */
