...
extern GX_STUDIO_DISPLAY_INFO all_widgets_synergy_display_table[];
...
#if defined(GX_TARGET_WIN32) || defined(__linux__)
...
VOID start_guix(void)
{
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_synergy_display_table[0].display,
        GX_CANVAS_COMPOSITE,
