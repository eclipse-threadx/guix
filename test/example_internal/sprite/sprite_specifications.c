...
GX_STUDIO_DISPLAY_INFO sprite_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
...
GX_SPRITE_FRAME main_screen_sprite_1_frame_list[6] =
{
    {
...
GX_SPRITE_PROPERTIES main_screen_sprite_1_properties =
{
    main_screen_sprite_1_frame_list,         /* address of frame list          */
    6,                                       /* frame count                    */
};
GX_SPRITE_FRAME main_screen_sprite_2_frame_list[6] =
{
    {
        GX_PIXELMAP_ID_FRAME_005,            /* pixelmap id                    */
        0,                                   /* x offset                       */
...
GX_SPRITE_PROPERTIES main_screen_sprite_2_properties =
{
    main_screen_sprite_2_frame_list,         /* address of frame list          */
    6,                                       /* frame count                    */
};

GX_CONST GX_STUDIO_WIDGET main_screen_sprite_2_define =
{
    "sprite_2",
    ...
    {167, 243, 283, 343},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_sprite_2), /* control block */
    (void *) &main_screen_sprite_2_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET main_screen_sprite_1_define =
{
    "sprite_1",
    GX_TYPE_SPRITE,                          /* widget type                    */
    ID_BIRD_SPRITE,                          /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {164, 83, 280, 183},                     /* widget size                    */
    &main_screen_sprite_2_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_sprite_1), /* control block */
    (void *) &main_screen_sprite_1_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_pixelmap_button_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {146, 57, 455, 392},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &main_screen_sprite_1_define,            /* child widget definition        */
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_screen_pixelmap_button_1_define,   /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_screen_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY sprite_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = sprite_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &sprite_display_table[display];
