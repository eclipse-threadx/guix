...
GX_STUDIO_DISPLAY_INFO polygon_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CONST GX_STUDIO_WIDGET_ENTRY polygon_32bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = polygon_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &polygon_32bpp_display_table[display];
