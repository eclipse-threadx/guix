...
{
    sprintf_s(wheel->gx_numeric_scroll_wheel_string_buffer, GX_NUMERIC_SCROLL_WHEEL_STRING_BUFFER_SIZE, "%02d", row + 1);
    return wheel->gx_numeric_scroll_wheel_string_buffer;
}
