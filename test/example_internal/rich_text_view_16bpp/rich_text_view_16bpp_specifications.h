...
#ifndef _RICH_TEXT_VIEW_16BPP_SPECIFICATIONS_H_
#define _RICH_TEXT_VIEW_16BPP_SPECIFICATIONS_H_
...
#define ID_SCROLLBAR_CHECK 1
#define ID_WHITESPACE_SLIDER 2
#define ID_LINE_SPACE_SLIDER 3
#define ID_WHITESPACE_VALUE 4
#define ID_LINE_SPACE_VALUE 5
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_CHECKBOX main_screen_scrollbar_check;
    GX_SLIDER main_screen_whitespace_slider;
    GX_SLIDER main_screen_line_space_slider;
    GX_PROMPT main_screen_whitespace_label;
    GX_PROMPT main_screen_line_space_label;
    GX_RICH_TEXT_VIEW main_screen_rich_text_view;
    GX_SCROLLBAR main_screen_vertical_scroll;
    GX_NUMERIC_PROMPT main_screen_whitespace_value;
    GX_NUMERIC_PROMPT main_screen_line_space_value;
