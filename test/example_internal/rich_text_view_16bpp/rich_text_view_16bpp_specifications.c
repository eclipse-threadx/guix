...
GX_STUDIO_DISPLAY_INFO rich_text_view_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CHECKBOX_PROPERTIES main_screen_scrollbar_check_properties =
{
...
GX_SLIDER_PROPERTIES main_screen_whitespace_slider_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    20,                                      /* maximum value                  */
...
GX_SLIDER_PROPERTIES main_screen_line_space_slider_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    10,                                      /* maximum value                  */
...
GX_PROMPT_PROPERTIES main_screen_whitespace_label_properties =
{
...
GX_PROMPT_PROPERTIES main_screen_line_space_label_properties =
{
...
{
    GX_STRING_ID_RICH_TEXT_4,                /* string id                      */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_NUMERIC_PROMPT_PROPERTIES main_screen_whitespace_value_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_NUMERIC_PROMPT_PROPERTIES main_screen_line_space_value_properties =
{
    0,                                       /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET main_screen_line_space_value_define =
{
    "line_space_value",
    GX_TYPE_NUMERIC_PROMPT,                  /* widget type                    */
    ID_LINE_SPACE_VALUE,                     /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {489, 237, 521, 260},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_line_space_value), /* control block */
    (void *) &main_screen_line_space_value_properties /* extended properties   */
};

GX_CONST GX_STUDIO_WIDGET main_screen_whitespace_value_define =
{
    "whitespace_value",
    GX_TYPE_NUMERIC_PROMPT,                  /* widget type                    */
    ID_WHITESPACE_VALUE,                     /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED|GX_STYLE_TEXT_CENTER,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {489, 176, 521, 199},                    /* widget size                    */
    &main_screen_line_space_value_define,    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_whitespace_value), /* control block */
    (void *) &main_screen_whitespace_value_properties /* extended properties   */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_rich_text_view_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {99, 94, 293, 350},                      /* widget size                    */
    &main_screen_whitespace_value_define,    /* next widget definition         */
...
GX_CONST GX_STUDIO_WIDGET main_screen_line_space_label_define =
{
    "line_space_label",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {329, 211, 419, 234},                    /* widget size                    */
    &main_screen_rich_text_view_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_line_space_label), /* control block */
    (void *) &main_screen_line_space_label_properties /* extended properties   */
};

GX_CONST GX_STUDIO_WIDGET main_screen_whitespace_label_define =
{
    "whitespace_label",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {328, 149, 428, 172},                    /* widget size                    */
    &main_screen_line_space_label_define,    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_whitespace_label), /* control block */
    (void *) &main_screen_whitespace_label_properties /* extended properties   */
};

GX_CONST GX_STUDIO_WIDGET main_screen_line_space_slider_define =
{
    "line_space_slider",
    GX_TYPE_SLIDER,                          /* widget type                    */
    ID_LINE_SPACE_SLIDER,                    /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {338, 235, 478, 258},                    /* widget size                    */
    &main_screen_whitespace_label_define,    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_line_space_slider), /* control block */
    (void *) &main_screen_line_space_slider_properties /* extended properties  */
};

GX_CONST GX_STUDIO_WIDGET main_screen_whitespace_slider_define =
{
    "whitespace_slider",
    GX_TYPE_SLIDER,                          /* widget type                    */
    ID_WHITESPACE_SLIDER,                    /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_SHOW_NEEDLE|GX_STYLE_SHOW_TICKMARKS,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {339, 173, 479, 196},                    /* widget size                    */
    &main_screen_line_space_slider_define,   /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_whitespace_slider), /* control block */
    (void *) &main_screen_whitespace_slider_properties /* extended properties  */
};

GX_CONST GX_STUDIO_WIDGET main_screen_scrollbar_check_define =
{
    "scrollbar_check",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_SCROLLBAR_CHECK,                      /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {334, 98, 461, 121},                     /* widget size                    */
    &main_screen_whitespace_slider_define,   /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_scrollbar_check), /* control block */
    (void *) &main_screen_scrollbar_check_properties /* extended properties    */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_title_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {239, 16, 390, 39},                      /* widget size                    */
    &main_screen_scrollbar_check_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY rich_text_view_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = rich_text_view_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &rich_text_view_16bpp_display_table[display];
