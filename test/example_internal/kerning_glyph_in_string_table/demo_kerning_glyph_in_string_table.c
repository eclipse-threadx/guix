...
#include "kerning_glyph_in_string_table_resources.h"
#include "kerning_glyph_in_string_table_specifications.h"

#define MAX_PATH_LENGTH 255

GX_CHAR binres_pathname[] = "kerning_glyph_in_string_table_resources.bin";
...
extern GX_STUDIO_DISPLAY_INFO kerning_glyph_in_string_table_display_table[1];
...
UINT status = 0;
    ...
    case GX_SIGNAL(ID_RADIO_BUTTON_THEME1, GX_EVENT_RADIO_SELECT):
        gx_display_theme_install(kerning_glyph_in_string_table_display_table[DISPLAY_1].display, display_1_theme_table[DISPLAY_1_THEME_1]);
        break;
...
UINT load_binres_theme(GX_UBYTE *root_address, INT theme_id)
{
    ...
    if (theme)
    {
        gx_display_theme_install(kerning_glyph_in_string_table_display_table[DISPLAY_1].display, theme);
    }
