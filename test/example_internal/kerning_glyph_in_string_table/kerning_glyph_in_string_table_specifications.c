...
GX_STUDIO_DISPLAY_INFO kerning_glyph_in_string_table_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    {10, 20, 309, 219},                      /* widget size                    */
    GX_NULL,                                 /* next widget                    */
    &window_radio_button_theme1_define,      /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY kerning_glyph_in_string_table_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = kerning_glyph_in_string_table_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &kerning_glyph_in_string_table_display_table[display];
