...
#include "jpeg_draw_16bpp_resources.h"
#include "jpeg_draw_16bpp_specifications.h"
...
{
    gx_context_raw_fill_color_set(GX_COLOR_BROWN);
    gx_context_raw_line_color_set(GX_COLOR_MAGENTA);
    gx_context_brush_width_set(1);
    gx_context_brush_style_set(GX_BRUSH_SOLID_FILL);
    gx_canvas_rectangle_draw(&window->gx_window_client);
    gx_widget_children_draw((GX_WINDOW*) window);
}
