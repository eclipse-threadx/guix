...
#ifndef _HORIZONTAL_LIST_32BPP_SPECIFICATIONS_H_
#define _HORIZONTAL_LIST_32BPP_SPECIFICATIONS_H_
...
#define ID_REMOVE_LAST_INDEX 5
#define ID_HORIZONTAL_LIST_1 6
#define ID_BUTTON_SET_TOTAL_COLS 7
#define ID_TEXT_INPUT_SET_TOTAL_COLS 8
...
typedef struct WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_HORIZONTAL_LIST window_horizontal_list_scroll;
    GX_SCROLLBAR window_hscroll_1;
    GX_HORIZONTAL_LIST window_horizontal_list_wrap;
    GX_HORIZONTAL_LIST window_horizontal_list;
    GX_TEXT_BUTTON window_button_1;
    GX_TEXT_BUTTON window_button_2;
    GX_TEXT_BUTTON window_button_3;
    GX_TEXT_BUTTON window_button_remove_last_index;
    ...
    GX_NUMERIC_PROMPT window_horizontal_list_1_selected_prompt;
    GX_HORIZONTAL_LIST window_empty_list;
    GX_TEXT_BUTTON window_button_set_total_cols;
    GX_SINGLE_LINE_TEXT_INPUT window_text_input_set_total_cols;
...
VOID list_callback(GX_HORIZONTAL_LIST *, GX_WIDGET *, INT);
