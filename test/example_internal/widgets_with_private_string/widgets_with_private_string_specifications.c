...
GX_STUDIO_DISPLAY_INFO widgets_with_private_string_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
...
GX_CONST GX_RESOURCE_ID main_screen_string_wheel_string_id_list[]={
    GX_STRING_ID_STRING_63,
    GX_STRING_ID_STRING_69,
    GX_STRING_ID_STRING_70
};
GX_STRING_SCROLL_WHEEL_PROPERTIES main_screen_string_wheel_properties =
{
    3,                                       /* total rows                     */
    1,                                       /* selected row                   */
    45,                                      /* row height                     */
    ...
    main_screen_string_wheel_string_id_list, /* string list                    */
    GX_NULL                                  /* callback                       */
...
GX_PIXELMAP_PROMPT_PROPERTIES main_screen_pixelmap_prompt_properties =
{
...
GX_TEXT_BUTTON_PROPERTIES main_screen_text_button_properties =
{
...
GX_RICH_TEXT_FONTS main_screen_rich_text_view_fonts =
{
...
GX_RICH_TEXT_VIEW_PROPERTIES main_screen_rich_text_view_properties =
{
    ...
    0,                                       /* whitespace                     */
    0,                                       /* line_space                     */
    &main_screen_rich_text_view_fonts,       /* fonts                          */
};
GX_TREE_VIEW_PROPERTIES main_screen_tree_view_properties =
{
    0,                                       /* expand map id                  */
    0,                                       /* collapse map id                */
...
GX_MENU_PROPERTIES main_screen_menu_properties =
{
...
GX_MENU_PROPERTIES main_screen_menu_1_properties =
{
    GX_STRING_ID_STRING_8,                   /* string id                      */
    GX_FONT_ID_PROMPT,                       /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
...
GX_CONST GX_STUDIO_WIDGET main_screen_menu_1_define =
{
    "menu_1",
    ...
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_THIN|GX_STYLE_ENABLED|GX_STYLE_TEXT_COPY|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    {256, 331, 355, 354},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_menu_1), /* control block  */
    (void *) &main_screen_menu_1_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_screen_menu_define =
{
    "menu",
    GX_TYPE_MENU,                            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {256, 307, 355, 330},                    /* widget size                    */
    &main_screen_menu_1_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_menu), /* control block    */
    (void *) &main_screen_menu_properties    /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_screen_tree_view_define =
{
    "tree_view",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {233, 306, 399, 400},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &main_screen_menu_define,                /* child widget definition        */
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_tree_view), /* control block */
    (void *) &main_screen_tree_view_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET main_screen_rich_text_view_define =
{
    "rich_text_view",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {29, 122, 194, 208},                     /* widget size                    */
    &main_screen_tree_view_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_rich_text_view), /* control block */
    (void *) &main_screen_rich_text_view_properties /* extended properties     */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_text_view_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {29, 228, 195, 326},                     /* widget size                    */
    &main_screen_rich_text_view_define,      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_text_button_define =
{
    "text_button",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {364, 21, 523, 44},                      /* widget size                    */
    &main_screen_radio_button_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_text_button), /* control block */
    (void *) &main_screen_text_button_properties /* extended properties        */
};

GX_CONST GX_STUDIO_WIDGET main_screen_pixelmap_prompt_define =
{
    "pixelmap_prompt",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {38, 63, 187, 86},                       /* widget size                    */
    &main_screen_text_button_define,         /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_pixelmap_prompt), /* control block */
    (void *) &main_screen_pixelmap_prompt_properties /* extended properties    */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {38, 27, 117, 50},                       /* widget size                    */
    &main_screen_pixelmap_prompt_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_screen_string_wheel_define =
{
    "string_wheel",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {235, 154, 404, 262},                    /* widget size                    */
    &main_screen_prompt_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_SCREEN_CONTROL_BLOCK, main_screen_string_wheel), /* control block */
    (void *) &main_screen_string_wheel_properties /* extended properties       */
};
...
GX_CONST GX_STUDIO_WIDGET main_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_screen_string_wheel_define,        /* child widget                   */
    0,                                       /* control block                  */
...
GX_CONST GX_STUDIO_WIDGET scroll_wheel_screen_month_wheel_1_define =
{
    ...
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_ENABLED|GX_STYLE_TEXT_COPY|GX_STYLE_TEXT_SCROLL_WHEEL_ROUND|GX_STYLE_TEXT_CENTER,   /* style flags */
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(GX_STRING_SCROLL_WHEEL),          /* control block size             */
    GX_COLOR_ID_WINDOW_FILL,                 /* normal color id                */
    GX_COLOR_ID_WINDOW_FILL,                 /* selected color id              */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY widgets_with_private_string_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = widgets_with_private_string_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &widgets_with_private_string_display_table[display];
