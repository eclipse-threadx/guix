...
#ifndef _WIDGETS_WITH_PRIVATE_STRING_SPECIFICATIONS_H_
#define _WIDGETS_WITH_PRIVATE_STRING_SPECIFICATIONS_H_
...
#define ID_PIXELMAP_PROMPT 1
#define ID_RADIO_BUTTON 2
#define ID_CHECKBOX 3
#define ID_MULTI_LINE_TEXT_BUTTON 4
#define ID_MULTI_LINE_TEXT_VIEW 5
#define ID_SCROLL_WHEEL_SCREEN 6
#define ID_MONTH_WHEEL_RUNTIME 7
#define ID_PROMPT 8
#define ID_TEXT_BUTTON 9
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_STRING_SCROLL_WHEEL main_screen_string_wheel;
    GX_PROMPT main_screen_prompt;
    GX_PIXELMAP_PROMPT main_screen_pixelmap_prompt;
    GX_TEXT_BUTTON main_screen_text_button;
    ...
    GX_RICH_TEXT_VIEW main_screen_rich_text_view;
    GX_TREE_VIEW main_screen_tree_view;
    GX_MENU main_screen_menu;
    GX_MENU main_screen_menu_1;
