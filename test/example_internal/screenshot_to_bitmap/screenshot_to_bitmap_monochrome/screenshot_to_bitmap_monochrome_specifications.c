...
ULONG      Primary_canvas_memory[9740];

extern GX_CONST GX_THEME *Primary_theme_table[];
extern GX_CONST GX_STRING *Primary_language_table[];

GX_STUDIO_DISPLAY_INFO screenshot_to_bitmap_monochrome_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
    ...
    38961,                                   /* canvas memory size in bytes    */
    0                                        /* rotation angle                 */
    }
};
...
GX_STRING_SCROLL_WHEEL_PROPERTIES scroll_wheel_screen_month_wheel_properties =
{
    ...
    GX_COLOR_ID_WHITE,                       /* normal text color id           */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY screenshot_to_bitmap_monochrome_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = screenshot_to_bitmap_monochrome_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &screenshot_to_bitmap_monochrome_display_table[display];
