...
#include "screenshot_to_bitmap_4bpp_specifications.h"
...
VOID start_guix(void)
{
    ...
    gx_studio_display_configure(PRIMARY, win32_graphics_driver_setup_4bpp_grayscale,
...
void scroll_wheel_value_set(GX_PROMPT *prompt, INT selected_row)
{
    ...
    string.gx_string_length = strnlen(text, sizeof(text));
