...
GX_STUDIO_DISPLAY_INFO screenshot_to_bitmap_332rgb_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
...
GX_STRING_SCROLL_WHEEL_PROPERTIES scroll_wheel_screen_month_wheel_properties =
{
    ...
    GX_COLOR_ID_BLACK,                       /* selected text color id         */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY screenshot_to_bitmap_332rgb_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = screenshot_to_bitmap_332rgb_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &screenshot_to_bitmap_332rgb_display_table[display];
