...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_synergy_24xrgb_rotated_cw_dave2d_disabled_resources.h"
#include "all_widgets_synergy_24xrgb_rotated_cw_dave2d_disabled_specifications.h"
