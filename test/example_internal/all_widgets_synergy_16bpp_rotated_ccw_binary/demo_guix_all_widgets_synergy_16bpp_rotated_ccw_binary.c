...
#define            DYNAMIC_MEMORY_SIZE 7000 * 1024
...
GX_CHAR binres_pathname[] = "all_widgets_synergy_16bpp_rotated_ccw_binary_resources.bin";
...
VOID  demo_thread_entry(ULONG thread_input)
{
    tx_byte_pool_create(&memory_pool, "dynamic memory buffer", dynamic_memory_buffer, DYNAMIC_MEMORY_SIZE);
