...
GX_STUDIO_DISPLAY_INFO color_convert_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_CHECKBOX_PROPERTIES window_alpha_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES window_jpeg_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES window_png_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_png_define =
{
    "png",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_PNG_RADIO,                            /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {287, 157, 366, 180},                    /* widget size                    */
    &window_prompt_1_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_png), /* control block               */
    (void *) &window_png_properties          /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_jpeg_define =
{
    "jpeg",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_JPEG_RADIO,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {287, 199, 366, 222},                    /* widget size                    */
    &window_png_define,                      /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_jpeg), /* control block              */
    (void *) &window_jpeg_properties         /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET window_alpha_define =
{
    "alpha",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {184, 423, 263, 446},                    /* widget size                    */
    &window_jpeg_define,                     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_alpha), /* control block             */
    (void *) &window_alpha_properties        /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_compress_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {346, 423, 459, 446},                    /* widget size                    */
    &window_alpha_define,                    /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET window_pixelmap_window_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {40, 98, 261, 394},                      /* widget size                    */
    &window_compress_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY color_convert_32bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = color_convert_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &color_convert_32bpp_display_table[display];
