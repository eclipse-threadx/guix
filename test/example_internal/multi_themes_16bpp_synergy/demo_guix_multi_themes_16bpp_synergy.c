...
#include "multi_themes_16bpp_synergy_resources.h"
#include "multi_themes_16bpp_synergy_specifications.h"
...
extern GX_STUDIO_DISPLAY_INFO multi_themes_16bpp_synergy_display_table[];
...
GX_CHAR binres_pathname[] = "multi_themes_16bpp_synergy_resources.bin";
...
VOID tx_application_define(void *first_unused_memory)
{
    ...
    gx_studio_display_configure(MAIN_DISPLAY, win32_dave2d_graphics_driver_setup_565rgb,
...
UINT simple_window_event_handler(GX_WINDOW *widget, GX_EVENT *event_ptr)
{
    ...
    case GX_SIGNAL(ID_THEME_1, GX_EVENT_RADIO_SELECT):
        gx_display_theme_install(multi_themes_16bpp_synergy_display_table[MAIN_DISPLAY].display, main_display_theme_table[MAIN_DISPLAY_THEME_1]);
        break;
    ...
    case GX_SIGNAL(ID_THEME_3, GX_EVENT_RADIO_SELECT):
        gx_display_theme_install(multi_themes_16bpp_synergy_display_table[MAIN_DISPLAY].display, main_display_theme_table[MAIN_DISPLAY_THEME_3]);
        break;
