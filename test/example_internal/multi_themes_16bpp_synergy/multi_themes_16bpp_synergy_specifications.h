...
#ifndef _MULTI_THEMES_16BPP_SYNERGY_SPECIFICATIONS_H_
#define _MULTI_THEMES_16BPP_SYNERGY_SPECIFICATIONS_H_
...
#define ID_ENGLISH 8
#define ID_CHINESE 9
#define ID_JAPANESE 10
#define ID_SPANISH 11
...
typedef struct SIMPLE_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_RADIO_BUTTON simple_window_radio_button_theme_3;
    GX_RADIO_BUTTON simple_window_radio_button_theme_4;
    GX_RADIO_BUTTON simple_window_radio_button_theme_5;
    ...
    GX_RADIO_BUTTON simple_window_radio_button_Japanese;
    GX_RADIO_BUTTON simple_window_radio_button_Spanish;
    GX_ICON simple_window_icon;
    GX_PROMPT simple_window_prompt;
    GX_PROMPT simple_window_prompt_1;
    GX_ICON simple_window_icon_1;
    GX_PROMPT simple_window_prompt_2;
    GX_ICON simple_window_icon_2;
    GX_PROMPT simple_window_prompt_3;
    GX_ICON simple_window_icon_3;
    GX_PROMPT simple_window_prompt_Themes_1;
    GX_PROMPT simple_window_prompt_4;
