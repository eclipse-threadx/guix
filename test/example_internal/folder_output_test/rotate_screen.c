...
INT                   rotate_angle = 30;
INT                   rotate_pixelmap_id = GX_PIXELMAP_ID_MAIN_DISPLAY_ROTATE_FOOT;
...
VOID update_angle_prompt()
{
    ...
    gx_widget_find((GX_WIDGET *)&MAIN_DISPLAY_rotate_screen, ID_ANGLE_DISPLAY, 0, &pp);
...
UINT status = 0;
    ...
    case GX_SIGNAL(ID_SLIDER_ANGLE, GX_EVENT_SLIDER_VALUE):
        ...
        update_angle_prompt();
        gx_system_dirty_mark((GX_WIDGET *)&MAIN_DISPLAY_rotate_screen.MAIN_DISPLAY_rotate_screen_pixelmap_window);
        break;

    case GX_SIGNAL(ID_RADIO_FOOT, GX_EVENT_RADIO_SELECT):
        rotate_pixelmap_id = GX_PIXELMAP_ID_MAIN_DISPLAY_ROTATE_FOOT;
        gx_system_dirty_mark((GX_WIDGET *)&MAIN_DISPLAY_rotate_screen.MAIN_DISPLAY_rotate_screen_pixelmap_window);
        break;

    case GX_SIGNAL(ID_RADIO_APPLE, GX_EVENT_RADIO_SELECT):
        rotate_pixelmap_id = GX_PIXELMAP_ID_MAIN_DISPLAY_ROTATE_APPLE;
        gx_system_dirty_mark((GX_WIDGET *)&MAIN_DISPLAY_rotate_screen.MAIN_DISPLAY_rotate_screen_pixelmap_window);
        break;

    case GX_SIGNAL(ID_RADIO_FISH, GX_EVENT_RADIO_SELECT):
        rotate_pixelmap_id = GX_PIXELMAP_ID_MAIN_DISPLAY_ROTATE_FISH;
        gx_system_dirty_mark((GX_WIDGET *)&MAIN_DISPLAY_rotate_screen.MAIN_DISPLAY_rotate_screen_pixelmap_window);
        break;
...
INT y_axis;
    ...
    win_size = MAIN_DISPLAY_rotate_screen.MAIN_DISPLAY_rotate_screen_pixelmap_window.gx_widget_size;
