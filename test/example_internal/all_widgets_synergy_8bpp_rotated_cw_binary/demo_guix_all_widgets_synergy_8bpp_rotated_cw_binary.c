...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_synergy_8bpp_rotated_cw_binary_resources.h"
#include "all_widgets_synergy_8bpp_rotated_cw_binary_specifications.h"
...
GX_CHAR binres_pathname[] = "all_widgets_synergy_8bpp_rotated_cw_binary_resources.bin";
