...
GX_STUDIO_DISPLAY_INFO synergy_glyph_draw_32bpp_screen_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(synergy_glyph_draw_32bpp_screen_display_table[0].display, props->string_id, &text);
...
GX_PROMPT_PROPERTIES window_prompt_13_properties =
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
    GX_FONT_ID_CHINESE_8BIT_COMPRESS,        /* font id                        */
...
GX_PROMPT_PROPERTIES window_prompt_3_properties =
{
    ...
    GX_FONT_ID_CHINESE_8BIT_RAW,             /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
...
{
    GX_STRING_ID_STRING_2,                   /* string id                      */
    GX_FONT_ID_CHINESE_1BIT_RAW,             /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
...
{
    GX_STRING_ID_STRING_2,                   /* string id                      */
    GX_FONT_ID_CHINESE_4BIT_COMPRESS,        /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
...
{
    GX_STRING_ID_STRING_1,                   /* string id                      */
    GX_FONT_ID_CHINESE_1BIT_COMPRESS,        /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
...
GX_CONST GX_STUDIO_WIDGET window_prompt_13_define =
{
    "prompt_13",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {52, 101, 551, 124},                     /* widget size                    */
    &window_prompt_3_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_prompt_13), /* control block         */
    (void *) &window_prompt_13_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &window_prompt_13_define,                /* child widget                   */
    0,                                       /* control block                  */
    (void *) &window_properties              /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY synergy_glyph_draw_32bpp_screen_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = synergy_glyph_draw_32bpp_screen_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &synergy_glyph_draw_32bpp_screen_display_table[display];
