...
/*  08-07-2015     William E. Lamie         Modified comment(s), added    */
...
#define GX_TYPE_CIRCULAR_GAUGE              139
...
#define GX_STATUS_ACCEPTS_INPUT             0x00000004
#define GX_STATUS_DEFAULT_FOCUS             0x00000010
#define GX_STATUS_ACCEPTS_FOCUS             0x00000020
#define GX_STATUS_HAS_FOCUS                 0x00000040
#define GX_STATUS_NOTIFY_ON_GAIN_FOCUS      0x00000080
#define GX_STATUS_NAV_STOP                  0x00000100
#define GX_STATUS_NAV_PARENT                0x00000200
#define GX_STATUS_MOVABLE                   0x00001000
#define GX_STATUS_BUTTON_DERIVED            0x00002000
#define GX_STATUS_TOGGLE_UNLOCK             0x00004000
#define GX_STATUS_DIRTY                     0x00008000
...
#define gx_circular_gauge_animation_steps_set                    _gx_circular_gauge_animation_set
#define gx_circular_gauge_create(a, b, c, d, e, f, g, h, i)      _gx_circular_gauge_create((GX_CIRCULAR_GAUGE *) a, b, c, d, e, f, g, h, i)
#define gx_circular_gauge_info_get                               _gx_circular_gauge_info_get
#define gx_circular_gauge_info_set                               _gx_circular_gauge_info_set
...
#define gx_progress_bar_fill_color_set                           _gx_progress_bar_fill_color_set
...
UINT  _gx_circular_gauge_info_get(GX_CIRCULAR_GAUGE *circular_gauge, GX_CIRCULAR_GAUGE_INFO *return_info);
UINT  _gx_circular_gauge_info_set(GX_CIRCULAR_GAUGE *circular_gauge, GX_CIRCULAR_GAUGE_INFO *info);
...
UINT _gx_progress_bar_fill_color_set(GX_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID fill_color_id);
...
#define gx_circular_gauge_create(a, b, c, d, e, f, g, h, i)      _gxe_circular_gauge_create((GX_CIRCULAR_GAUGE *) a, b, c, d, e, f, g, h, i)
#define gx_circular_gauge_info_get                               _gxe_circular_gauge_info_get
#define gx_circular_gauge_info_set                               _gxe_circular_gauge_info_set
...
#define gx_progress_bar_fill_color_set                           _gxe_progress_bar_fill_color_set
...
UINT  _gxe_circular_gauge_info_get(GX_CIRCULAR_GAUGE *circular_gauge, GX_CIRCULAR_GAUGE_INFO *return_info);
UINT  _gxe_circular_gauge_info_set(GX_CIRCULAR_GAUGE *circular_gauge, GX_CIRCULAR_GAUGE_INFO *info);
UINT  _gxe_circular_gauge_style_add(GX_CIRCULAR_GAUGE *circular_gauge, ULONG style);
UINT  _gxe_circular_gauge_style_remove(GX_CIRCULAR_GAUGE *circular_gauge, ULONG style);
...
UINT _gxe_progress_bar_fill_color_set(GX_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID fill_color_id);
