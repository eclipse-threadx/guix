...
#ifndef _ML_TEXT_VIEW_16BPP_SPECIFICATIONS_H_
#define _ML_TEXT_VIEW_16BPP_SPECIFICATIONS_H_
...
#define ID_FONT_1BPP 2
#define ID_FONT_4BPP 3
#define ID_FONT_8BPP 4
#define ID_SIZE_18PIX 5
#define ID_SIZE_24PIX 6
#define ID_UTF8 7
#define ID_ASCII 8
#define ID_ALIGN_LEFT 9
#define ID_ALIGN_CENTER 10
#define ID_ALIGN_RIGHT 11
#define ID_SLIDER_WHITESPACE 12
#define ID_SLIDER_LINE_SPACE 13
#define ID_PROMPT_WHITESPACE 14
#define ID_PROMPT_LINE_SPACE 15
...
typedef struct MAIN_SCREEN_CONTROL_BLOCK_STRUCT
{
    ...
    GX_WINDOW main_screen_font;
    GX_RADIO_BUTTON main_screen_font_1bpp;
    GX_RADIO_BUTTON main_screen_font_4bpp;
    GX_RADIO_BUTTON main_screen_font_8bpp;
    GX_WINDOW main_screen_font_size;
    GX_RADIO_BUTTON main_screen_font_size_18;
    GX_RADIO_BUTTON main_screen_font_size_24;
    GX_MULTI_LINE_TEXT_VIEW main_screen_text_view;
    GX_SCROLLBAR main_screen_vertical_scroll_1;
    GX_PROMPT main_screen_prompt_1;
    GX_WINDOW main_screen_window_1;
    GX_RADIO_BUTTON main_screen_font_1bpp_1;
    GX_RADIO_BUTTON main_screen_font_1bpp_2;
    ...
    GX_SLIDER main_screen_slider_whitespace;
    GX_SLIDER main_screen_slider_line_space;
    GX_PROMPT main_screen_prompt_whitespace;
    GX_PROMPT main_screen_prompt_line_space;
