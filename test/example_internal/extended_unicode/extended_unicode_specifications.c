...
GX_STUDIO_DISPLAY_INFO extended_unicode_display_table[1] =
{
    {
    "main_display",
    "main_display_canvas",
...
GX_PROMPT_PROPERTIES screen_base_prompt_1_properties =
{
    GX_STRING_ID_EXTENDED_UNICODES,          /* string id                      */
    GX_FONT_ID_OLD_ITALIC_8BPP,              /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
GX_PROMPT_PROPERTIES screen_base_prompt_properties =
{
    GX_STRING_ID_EXTENDED_UNICODES,          /* string id                      */
    GX_FONT_ID_OLD_ITALIC_1BPP,              /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};
GX_PROMPT_PROPERTIES screen_base_prompt_2_properties =
{
    GX_STRING_ID_EXTENDED_UNICODES,          /* string id                      */
    GX_FONT_ID_OLD_ITALIC_4BPP,              /* font id                        */
    GX_COLOR_ID_TEXT,                        /* normal text color              */
    GX_COLOR_ID_SELECTED_TEXT,               /* selected text color            */
    GX_COLOR_ID_TEXT                         /* disabled text color            */
};

GX_CONST GX_STUDIO_WIDGET screen_base_prompt_2_define =
{
    "prompt_2",
    ...
    {22, 247, 631, 321},                     /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(SCREEN_BASE_CONTROL_BLOCK, screen_base_prompt_2), /* control block */
    (void *) &screen_base_prompt_2_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET screen_base_prompt_define =
{
    "prompt",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {20, 123, 629, 197},                     /* widget size                    */
    &screen_base_prompt_2_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(SCREEN_BASE_CONTROL_BLOCK, screen_base_prompt), /* control block  */
    (void *) &screen_base_prompt_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET screen_base_prompt_1_define =
{
    "prompt_1",
    GX_TYPE_PROMPT,                          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {19, 14, 628, 88},                       /* widget size                    */
    &screen_base_prompt_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(SCREEN_BASE_CONTROL_BLOCK, screen_base_prompt_1), /* control block */
    (void *) &screen_base_prompt_1_properties /* extended properties           */
};
...
GX_CONST GX_STUDIO_WIDGET screen_base_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &screen_base_prompt_1_define,            /* child widget                   */
    0,                                       /* control block                  */
    (void *) &screen_base_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY extended_unicode_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = extended_unicode_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &extended_unicode_display_table[display];
