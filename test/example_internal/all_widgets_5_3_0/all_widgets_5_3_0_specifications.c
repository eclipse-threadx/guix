...
GX_STUDIO_DISPLAY_INFO all_widgets_5_3_0_display_table[1] =
{
    {
    "Primary",
    "Primary_canvas",
...
GX_CONST GX_STUDIO_WIDGET_ENTRY all_widgets_5_3_0_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = all_widgets_5_3_0_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    USHORT language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &all_widgets_5_3_0_display_table[display];
