...
extern GX_STUDIO_DISPLAY_INFO all_widgets_synergy_5_4_2_display_table[];
...
VOID start_guix(void)
{
    ...
    gx_studio_display_configure(PRIMARY, win32_dave2d_graphics_driver_setup_24xrgb, 
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_synergy_5_4_2_display_table[0].display,
        GX_CANVAS_COMPOSITE,
