...
#define gx_binres_language_table_read                            _gx_binres_language_table_read
#define gx_binres_theme_read                                     _gx_binres_theme_read
...
UINT _gx_binres_language_table_read(GX_UBYTE ****returned_language_table, UINT(*ReadBytes)(UINT offset, INT bytecount, GX_BYTE *put));
UINT _gx_binres_theme_read(INT theme_id, GX_THEME **returned_theme, UINT (*ReadBytes)(UINT offset, INT bytecount, GX_BYTE *put));
...
#define gx_binres_language_table_read                            _gxe_binres_language_table_read
#define gx_binres_theme_read                                     _gxe_binres_theme_read
...
UINT _gxe_binres_language_table_read(GX_UBYTE ****returned_language_table, UINT(*ReadBytes)(UINT offset, INT bytecount, GX_BYTE *put));
UINT _gxe_binres_theme_read(INT theme_id, GX_THEME **returned_theme, UINT (*ReadBytes)(UINT offset, INT bytecount, GX_BYTE *put));
