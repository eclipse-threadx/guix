...
VOID  demo_thread_entry(ULONG thread_input)
{
    ...
    string.gx_string_ptr = sl_input_text;
    string.gx_string_length = sizeof(sl_input_text) - 1;
    gx_single_line_text_input_character_insert(&widget_color_test_screen.widget_color_test_screen_sl_text_input, (GX_UBYTE *)string.gx_string_ptr, string.gx_string_length);
