...
GX_STUDIO_DISPLAY_INFO generic_16bpp_32bppdriver_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_RADIO_BUTTON_PROPERTIES main_window_565rgb_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES main_window_4444argb_properties =
{
...
GX_CONST GX_STUDIO_WIDGET main_window_4444argb_define =
{
    "4444argb",
    ...
    {206, 123, 304, 146},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_4444argb), /* control block */
    (void *) &main_window_4444argb_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET main_window_565rgb_define =
{
    "565rgb",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_565RGB,                               /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {205, 53, 298, 76},                      /* widget size                    */
    &main_window_4444argb_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_565rgb), /* control block  */
    (void *) &main_window_565rgb_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_compressed_box_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {123, 205, 243, 222},                    /* widget size                    */
    &main_window_565rgb_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY generic_16bpp_32bppdriver_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = generic_16bpp_32bppdriver_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &generic_16bpp_32bppdriver_display_table[display];
