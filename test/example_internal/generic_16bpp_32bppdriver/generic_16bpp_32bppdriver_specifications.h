...
#ifndef _GENERIC_16BPP_32BPPDRIVER_SPECIFICATIONS_H_
#define _GENERIC_16BPP_32BPPDRIVER_SPECIFICATIONS_H_
...
typedef struct MAIN_WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_RADIO_BUTTON main_window_565rgb;
    GX_RADIO_BUTTON main_window_4444argb;
