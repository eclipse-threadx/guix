...
GX_STUDIO_DISPLAY_INFO pixelmaps_4444argb_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
{
    GX_PIXELMAP_ID_COMPRESS_ALPHA_4444ARGB   /* wallpaper pixelmap id          */
};
...
GX_CONST GX_STUDIO_WIDGET_ENTRY pixelmaps_4444argb_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = pixelmaps_4444argb_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &pixelmaps_4444argb_display_table[display];
