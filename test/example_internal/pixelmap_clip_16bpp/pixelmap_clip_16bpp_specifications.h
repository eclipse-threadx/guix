...
#ifndef _PIXELMAP_CLIP_16BPP_SPECIFICATIONS_H_
#define _PIXELMAP_CLIP_16BPP_SPECIFICATIONS_H_
...
#define ID_CHECKBOX_ALPHA 1
#define ID_CHECKBOX_COMPRESSED 2
...
typedef struct WINDOW_CONTROL_BLOCK_STRUCT
{
    ...
    GX_CHECKBOX window_checkbox_alpha;
    GX_CHECKBOX window_checkbox_compressed;
