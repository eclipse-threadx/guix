...
GX_STUDIO_DISPLAY_INFO keyboard_8bpp_display_table[1] =
{
    ...
    130560,                                  /* canvas memory size in bytes    */
    0                                        /* rotation angle                 */
    }
};
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(keyboard_8bpp_display_table[0].display, props->string_id, &text);
...
GX_PIXELMAP_PROMPT_PROPERTIES keyboard_screen_prompt_1_properties =
{
...
GX_CONST GX_STUDIO_WIDGET keyboard_screen_keyboard_frame_define =
{
    ...
    {0, 80, 479, 269},                       /* widget size                    */
    &keyboard_screen_pixelmap_button_1_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET keyboard_screen_prompt_1_define =
{
    "prompt_1",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {0, 0, 479, 38},                         /* widget size                    */
    &keyboard_screen_keyboard_input_field_define, /* next widget definition    */
    &keyboard_screen_icon_1_define,          /* child widget definition        */
    offsetof(KEYBOARD_SCREEN_CONTROL_BLOCK, keyboard_screen_prompt_1), /* control block */
    (void *) &keyboard_screen_prompt_1_properties /* extended properties       */
};
...
GX_CONST GX_STUDIO_WIDGET keyboard_screen_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &keyboard_screen_prompt_1_define,        /* child widget                   */
    0,                                       /* control block                  */
    (void *) &keyboard_screen_properties     /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY keyboard_8bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = keyboard_8bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &keyboard_8bpp_display_table[display];
