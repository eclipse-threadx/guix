...
GX_SPRITE *sprite = &((SPRITE_SCREEN_CONTROL_BLOCK *)pSpriteScreen)->sprite_screen_sprite_1;
    ...
    {
        size.gx_rectangle_top = (GX_VALUE)(size.gx_rectangle_top - pSpriteScreen->gx_widget_size.gx_rectangle_bottom);
        size.gx_rectangle_bottom = (GX_VALUE)( size.gx_rectangle_bottom - pSpriteScreen->gx_widget_size.gx_rectangle_bottom);
    }
    ...
    {
        size.gx_rectangle_left = (GX_VALUE)(size.gx_rectangle_left - pSpriteScreen->gx_widget_size.gx_rectangle_right);
        size.gx_rectangle_right = (GX_VALUE)(size.gx_rectangle_right - pSpriteScreen->gx_widget_size.gx_rectangle_right);
    }
