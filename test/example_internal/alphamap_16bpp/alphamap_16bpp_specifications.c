...
GX_STUDIO_DISPLAY_INFO alphamap_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_SLIDER_PROPERTIES main_window_slider_alpha_properties =
{
    10,                                      /* tickmark count                 */
    0,                                       /* mimimun value                  */
    255,                                     /* maximum value                  */
...
GX_PROMPT_PROPERTIES main_window_prompt_alpha_properties =
{
...
GX_CONST GX_STUDIO_WIDGET main_window_prompt_alpha_define =
{
    "prompt_alpha",
    GX_TYPE_PROMPT,                          /* widget type                    */
    ID_ALPHA_PROMPT,                         /* widget id                      */
    ...
    {469, 448, 504, 471},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_prompt_alpha), /* control block */
    (void *) &main_window_prompt_alpha_properties /* extended properties       */
};

GX_CONST GX_STUDIO_WIDGET main_window_slider_alpha_define =
{
    "slider_alpha",
    GX_TYPE_SLIDER,                          /* widget type                    */
    ID_SLIDER_ALPHA,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {273, 447, 459, 470},                    /* widget size                    */
    &main_window_prompt_alpha_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_slider_alpha), /* control block */
    (void *) &main_window_slider_alpha_properties /* extended properties       */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_prompt_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {119, 449, 267, 472},                    /* widget size                    */
    &main_window_slider_alpha_define,        /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_window_window_1_define =
{
    ...
    GX_STATUS_ACCEPTS_FOCUS,                 /* status flags                   */
    sizeof(GX_WINDOW),                       /* control block size             */
    GX_COLOR_ID_SLIDER_NEEDLE_FILL,          /* normal color id                */
    GX_COLOR_ID_SLIDER_NEEDLE_FILL,          /* selected color id              */
    GX_COLOR_ID_SLIDER_NEEDLE_FILL,          /* disabled color id              */
    gx_studio_window_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) pixelmap_wnd_draw, /* drawing function override    */
    GX_NULL,                                 /* event function override        */
    {83, 80, 279, 351},                      /* widget size                    */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY alphamap_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = alphamap_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &alphamap_16bpp_display_table[display];
