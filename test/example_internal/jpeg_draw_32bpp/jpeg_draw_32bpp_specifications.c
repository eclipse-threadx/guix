...
GX_STUDIO_DISPLAY_INFO jpeg_draw_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_ICON_PROPERTIES main_window_icon_properties =
{
    GX_PIXELMAP_ID_BASN3P02_CORRECT,         /* normal pixelmap id             */
    0                                        /* selected pixelmap id           */
};
GX_ICON_PROPERTIES main_window_icon_1_properties =
{
    GX_PIXELMAP_ID_BASN3P02_INVALID_AC_TABLE, /* normal pixelmap id            */
    0                                        /* selected pixelmap id           */
};
GX_ICON_PROPERTIES main_window_icon_2_properties =
{
    GX_PIXELMAP_ID_BASN3P02_INVALID_DC_TABLE, /* normal pixelmap id            */
    0                                        /* selected pixelmap id           */
};
GX_ICON_PROPERTIES main_window_icon_3_properties =
{
    GX_PIXELMAP_ID_BASN3P02_INVALID_AC_TABLE_1, /* normal pixelmap id          */
    0                                        /* selected pixelmap id           */
};
GX_ICON_PROPERTIES main_window_icon_4_properties =
{
    GX_PIXELMAP_ID_BASN3P02_INVALID_SIZE,    /* normal pixelmap id             */
    0                                        /* selected pixelmap id           */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_icon_4_define =
{
    "icon_4",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {169, 362, 200, 393},                    /* widget size                    */
    &main_window_prompt_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_icon_4), /* control block  */
    (void *) &main_window_icon_4_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_window_icon_3_define =
{
    "icon_3",
    GX_TYPE_ICON,                            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {211, 404, 242, 435},                    /* widget size                    */
    &main_window_icon_4_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_icon_3), /* control block  */
    (void *) &main_window_icon_3_properties  /* extended properties            */
};

GX_CONST GX_STUDIO_WIDGET main_window_icon_2_define =
{
    "icon_2",
    GX_TYPE_ICON,                            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {169, 441, 200, 472},                    /* widget size                    */
    &main_window_icon_3_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_icon_2), /* control block  */
    (void *) &main_window_icon_2_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_icon_1_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {170, 403, 201, 434},                    /* widget size                    */
    &main_window_icon_2_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_window_icon_define =
{
    "icon",
    GX_TYPE_ICON,                            /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {332, 443, 363, 474},                    /* widget size                    */
    &main_window_icon_1_define,              /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_icon), /* control block    */
    (void *) &main_window_icon_properties    /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_window_2_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {506, 134, 683, 336},                    /* widget size                    */
    &main_window_icon_define,                /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_window_define =
{
    ...
    gx_studio_window_create,                 /* create function                */
    (VOID (*)(GX_WIDGET *)) main_window_draw, /* drawing function override     */
    GX_NULL,                                 /* event function override        */
...
GX_CONST GX_STUDIO_WIDGET_ENTRY jpeg_draw_32bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = jpeg_draw_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &jpeg_draw_32bpp_display_table[display];
