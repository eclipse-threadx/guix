...
GX_STUDIO_DISPLAY_INFO synergy_4444argb_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
GX_RADIO_BUTTON_PROPERTIES main_window_4444argb_com_button_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES main_window_4444bgra_uncom_button_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES main_window_4444bgra_com_button_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES main_window_4444argb_uncom_button_properties =
{
...
GX_CONST GX_STUDIO_WIDGET main_window_4444argb_uncom_button_define =
{
    "4444argb_uncom_button",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_4444ARGB_UNCOM,                       /* widget id                      */
    ...
    {4, 0, 171, 23},                         /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_4444argb_uncom_button), /* control block */
    (void *) &main_window_4444argb_uncom_button_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET main_window_4444bgra_com_button_define =
{
    "4444bgra_com_button",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_4444BGRA_COM,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_RADIO|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {170, 206, 315, 229},                    /* widget size                    */
    &main_window_4444argb_uncom_button_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_4444bgra_com_button), /* control block */
    (void *) &main_window_4444bgra_com_button_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET main_window_4444bgra_uncom_button_define =
{
    "4444bgra_uncom_button",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_4444BGRA_UNCOM,                       /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {8, 206, 165, 229},                      /* widget size                    */
    &main_window_4444bgra_com_button_define, /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_4444bgra_uncom_button), /* control block */
    (void *) &main_window_4444bgra_uncom_button_properties /* extended properties */
};

GX_CONST GX_STUDIO_WIDGET main_window_4444argb_com_button_define =
{
    "4444argb_com_button",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_4444ARGB_COM,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_RADIO|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {175, 0, 309, 23},                       /* widget size                    */
    &main_window_4444bgra_uncom_button_define, /* next widget definition       */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_4444argb_com_button), /* control block */
    (void *) &main_window_4444argb_com_button_properties /* extended properties */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_pic_window_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {29, 23, 199, 192},                      /* widget size                    */
    &main_window_4444argb_com_button_define, /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET_ENTRY synergy_4444argb_32bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = synergy_4444argb_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &synergy_4444argb_32bpp_display_table[display];
