...
#include <stdio.h>
#include "gx_api.h"
#include "sl_text_input_32bpp_resources.h"
...
INT      value;
    ...
    case GX_SIGNAL(ID_LEFT_ALIGN, GX_EVENT_RADIO_SELECT):
        gx_single_line_text_input_style_add((GX_WIDGET *)input, GX_STYLE_TEXT_LEFT);
        break;

    case GX_SIGNAL(ID_LEFT_ALIGN, GX_EVENT_RADIO_DESELECT):
        gx_single_line_text_input_style_remove((GX_WIDGET *)input, GX_STYLE_TEXT_LEFT);
        break;
        
    case GX_SIGNAL(ID_RIGHT_ALIGN, GX_EVENT_RADIO_SELECT):
        gx_single_line_text_input_style_add((GX_WIDGET *)input, GX_STYLE_TEXT_RIGHT);
        break;

    case GX_SIGNAL(ID_RIGHT_ALIGN, GX_EVENT_RADIO_DESELECT):
        gx_single_line_text_input_style_remove((GX_WIDGET *)input, GX_STYLE_TEXT_RIGHT);
        break;
