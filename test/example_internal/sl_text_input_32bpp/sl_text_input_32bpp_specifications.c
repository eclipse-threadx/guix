...
GX_STUDIO_DISPLAY_INFO sl_text_input_32bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(sl_text_input_32bpp_display_table[0].display, props->string_id, &text);
...
GX_WINDOW_PROPERTIES window_font_size_1_properties =
{
    0                                        /* wallpaper pixelmap id          */
};
GX_RADIO_BUTTON_PROPERTIES window_font_size_18_1_properties =
{
...
GX_RADIO_BUTTON_PROPERTIES window_font_size_24_1_properties =
{
...
GX_CONST GX_STUDIO_WIDGET window_font_size_24_1_define =
{
    "font_size_24_1",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_RIGHT_ALIGN,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_RADIO|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {244, 407, 345, 430},                    /* widget size                    */
    &window_prompt_7_define,                 /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_font_size_24_1), /* control block    */
    (void *) &window_font_size_24_1_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET window_font_size_18_1_define =
{
    "font_size_18_1",
    GX_TYPE_RADIO_BUTTON,                    /* widget type                    */
    ID_LEFT_ALIGN,                           /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_PUSHED|GX_STYLE_BUTTON_RADIO|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {244, 381, 356, 404},                    /* widget size                    */
    &window_font_size_24_1_define,           /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW_CONTROL_BLOCK, window_font_size_18_1), /* control block    */
    (void *) &window_font_size_18_1_properties /* extended properties          */
};

GX_CONST GX_STUDIO_WIDGET window_font_size_1_define =
{
    "font_size_1",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {237, 346, 351, 438},                    /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    &window_font_size_18_1_define,           /* child widget definition        */
    offsetof(WINDOW_CONTROL_BLOCK, window_font_size_1), /* control block       */
    (void *) &window_font_size_1_properties  /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window_window_1_define =
{
    ...
    &window_font_size_1_define,              /* next widget definition         */
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = sl_text_input_32bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &sl_text_input_32bpp_display_table[display];
