...
GX_STUDIO_DISPLAY_INFO lines_8bpp_display_table[1] =
{
    ...
    225280,                                  /* canvas memory size in bytes    */
    0                                        /* rotation angle                 */
    }
};
...
GX_CONST GX_STUDIO_WIDGET_ENTRY lines_8bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = lines_8bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &lines_8bpp_display_table[display];
