...
GX_STUDIO_DISPLAY_INFO lines_display_table[1] =
{
    ...
    901120,                                  /* canvas memory size in bytes    */
    0                                        /* rotation angle                 */
    }
};
...
GX_SLIDER_PROPERTIES main_window_line_width_slider_properties =
{
    10,                                      /* tickmark count                 */
    1,                                       /* mimimun value                  */
    10,                                      /* maximum value                  */
...
GX_CONST GX_STUDIO_WIDGET main_window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_window_prompt_1_define,            /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_window_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY lines_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = lines_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &lines_display_table[display];
