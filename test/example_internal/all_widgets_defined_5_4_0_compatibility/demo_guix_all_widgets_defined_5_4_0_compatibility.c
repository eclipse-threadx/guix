...
extern GX_STUDIO_DISPLAY_INFO all_widgets_defined_5_4_0_compatibility_display_table[];
...
VOID color_set_API_compatibility_test();
...
VOID start_guix(void)
{
    ...
    gx_studio_named_widget_create("math_screen", GX_NULL, GX_NULL);
    ...
    gx_canvas_create(&composite_canvas, GX_NULL,
        all_widgets_defined_5_4_0_compatibility_display_table[0].display,
        GX_CANVAS_COMPOSITE,
    ...
    color_set_API_compatibility_test();
...
UINT text_screen_event_handler(GX_WINDOW *window, GX_EVENT *event_ptr)
{
    ...
    case GX_SIGNAL(ID_SL_INPUT, GX_EVENT_TEXT_EDITED):
        gx_single_line_text_input_buffer_get(&text_screen.text_screen_text_input_1, (GX_CHAR **)&string.gx_string_ptr, &string.gx_string_length, &buffer_size);
        if ((string.gx_string_length == text_screen.text_screen_text_input_1.gx_single_line_text_input_string_size) &&
            (buffer_size == text_screen.text_screen_text_input_1.gx_single_line_text_input_buffer_size))
        {
    ...
    case GX_SIGNAL(ID_ML_INPUT, GX_EVENT_TEXT_EDITED):
        gx_multi_line_text_input_buffer_get(&text_screen.text_screen_text_input_2, (GX_CHAR **)&string.gx_string_ptr, &string.gx_string_length, &buffer_size);
        if ((string.gx_string_length == text_screen.text_screen_text_input_2.gx_multi_line_text_view_text.gx_string_length) &&
            (buffer_size == text_screen.text_screen_text_input_2.gx_multi_line_text_input_buffer_size))
        {
            gx_multi_line_text_view_text_set_ext(&text_screen.text_screen_text_view_1, &string);
        }
        break;
...
VOID color_set_API_compatibility_test()
{
    gx_widget_fill_color_set((GX_WIDGET *)&button_screen, GX_COLOR_ID_ORANGE, GX_COLOR_ID_BLUE);
    gx_prompt_text_color_set(&button_screen.button_screen_count_prompt, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
    gx_text_button_text_color_set(&button_screen.button_screen_text_button_1, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
    gx_multi_line_text_view_text_color_set(&text_screen.text_screen_text_view_1, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
    gx_progress_bar_text_color_set(&indicator_screen.indicator_screen_progress_bar_1, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
    gx_radial_progress_bar_text_color_set(&indicator_screen.indicator_screen_radial_progress_bar, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
    gx_text_scroll_wheel_text_color_set(&scroll_wheel_screen.scroll_wheel_screen_day_wheel, GX_COLOR_ID_BLUE, GX_COLOR_ID_ORANGE);
}
