...
static VOID footer_icons_animation_start(SCREEN_BASE_CONTROL_BLOCK *base)
{
    ...
    if (gx_system_animation_get(&animation) == GX_SUCCESS)
    {
        ...
        info.gx_animation_end_position.gx_point_y = DISPLAY_1_Y_RESOLUTION - 35;
    ...
    if (gx_system_animation_get(&animation) == GX_SUCCESS)
    {
        ...
        info.gx_animation_end_position.gx_point_x = DISPLAY_1_X_RESOLUTION - 91;
...
VOID title_animation_start(CONTROLLER_BASE_CONTROL_BLOCK *base)
{
    ...
    if (gx_system_animation_get(&animation) == GX_SUCCESS)
    {
        ...
        info.gx_animation_steps = 400 / GX_SYSTEM_TIMER_MS;
        info.gx_animation_frame_interval = 2;
        info.gx_animation_start_position.gx_point_x = base->gx_widget_size.gx_rectangle_left + 5;
        info.gx_animation_start_position.gx_point_y = base->gx_widget_size.gx_rectangle_top - 18;
        info.gx_animation_end_position.gx_point_x = base->gx_widget_size.gx_rectangle_left + 5;
        info.gx_animation_end_position.gx_point_y = base->gx_widget_size.gx_rectangle_top + 5;
...
static VOID slide_animation_start(GX_WINDOW *window)
{
    ...
    if (info)
    {
        ...
        slide_animation_info.gx_animation_steps = 300 / GX_SYSTEM_TIMER_MS;
