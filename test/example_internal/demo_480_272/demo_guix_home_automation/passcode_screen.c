...
static VOID on_clear()
{
    ...
    info.gx_animation_end_position.gx_point_y = 56;
...
static VOID on_show()
{
    ...
    {
        target_size = &passcode_screen.passcode_screen_num_pad.gx_widget_size;
        parent_size = &passcode_screen.gx_widget_size;
    
        info.gx_animation_target = (GX_WIDGET *)&passcode_screen.passcode_screen_num_pad;
        info.gx_animation_parent = (GX_WIDGET *)&passcode_screen;
        info.gx_animation_start_position.gx_point_x = target_size->gx_rectangle_left;
        info.gx_animation_start_position.gx_point_y = parent_size->gx_rectangle_top - target_size->gx_rectangle_top - target_size->gx_rectangle_bottom;
        info.gx_animation_end_position.gx_point_x = target_size->gx_rectangle_left;;
        info.gx_animation_end_position.gx_point_y = target_size->gx_rectangle_top;
