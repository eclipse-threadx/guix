...
#define __GUIX_MINOR_VERSION 2
#define __GUIX_SERVICE_PACK  0
...
#ifndef GUIX_DISABLE_MULTITHREAD_SUPPORT
#define GUIX_MULTITHREAD_SUPPORT
#endif
...
#ifndef GX_EVENT_SIZE
#define GX_EVENT_SIZE                           24
#endif
...
#define GX_KEY_NEXT                             0x09
#define GX_KEY_SELECT                           0x0d
#define GX_KEY_SPACE                            0x20
#define GX_KEY_DELETE                           0x7f
#define GX_KEY_CARRIAGE_RETURN                  GX_KEY_SELECT
...
#define GX_TYPE_RADIO_BUTTON                    4
#define GX_TYPE_CHECKBOX                        5
#define GX_TYPE_PIXELMAP_BUTTON                 6
#define GX_TYPE_SHADOW_BUTTON                   7
#define GX_TYPE_ICON_BUTTON                     8
#define GX_TYPE_SPIN_BUTTON                     9
#define GX_TYPE_ICON                            10
#define GX_TYPE_SPRITE                          11
...
#define GX_STATUS_VISIBLE                       0x00000001
#define GX_STATUS_SELECTABLE                    0x00000002
#define GX_STATUS_ACCEPTS_INPUT                 0x00000008
#define GX_STATUS_ACCEPTS_FOCUS                 0x00000010
#define GX_STATUS_HAS_FOCUS                     0x00000020
#define GX_STATUS_MOVABLE                       0x00000040
#define GX_STATUS_TAB_STOP                      0x00000080
#define GX_STATUS_BUTTON_DERIVED                0x00000100
#define GX_STATUS_TOGGLE_UNLOCK                 0x00000200
#define GX_STATUS_TRANSPARENT                   0x10000000
#define GX_STATUS_NONCLIENT                     0x20000000
#define GX_STATUS_OWNS_INPUT                    0x40000000
#define GX_STATUS_DYNAMICALLY_ALLOCATED         0x80000000


/* Define Widget style flags.  */

#define GX_STYLE_NONE                           0x00000000
#define GX_STYLE_BORDER_NONE                    0x00000000
#define GX_STYLE_BORDER_RAISED                  0x00000001
#define GX_STYLE_BORDER_RECESSED                0x00000002
#define GX_STYLE_BORDER_THIN                    0x00000004
#define GX_STYLE_BORDER_THICK                   0x00000008
#define GX_STYLE_BORDER_MASK                    0x0000000f


/* Define global style flags.  */

#define GX_STYLE_TRANSPARENT                    0x10000000
#define GX_STYLE_DRAW_SELECTED                  0x20000000
#define GX_STYLE_ENABLED                        0x40000000
#define GX_STYLE_DYNAMICALLY_ALLOCATED          0x80000000

/* Define Button style flags.  */

#define GX_STYLE_BUTTON_PUSHED                  0x00000010
#define GX_STYLE_BUTTON_TOGGLE                  0x00000020
#define GX_STYLE_BUTTON_RADIO                   0x00000040
#define GX_STYLE_BUTTON_EVENT_ON_PUSH           0x00000080
#define GX_STYLE_BUTTON_REPEAT                  0x00000100

/* Define Sprite style flags */

#define GX_STYLE_SPRITE_AUTO                    0x00000010
#define GX_STYLE_SPRITE_LOOP                    0x00000020

/* Define List style flags.  */

#define GX_STYLE_CENTER_SELECTED                0x00000010
#define GX_STYLE_WRAP                           0x00000020
#define GX_STYLE_FLICKABLE                      0x00000040


/* Define Pixelmap button and icon button alignment flags.  */

#define GX_STYLE_HALIGN_CENTER                  0x00010000
#define GX_STYLE_HALIGN_LEFT                    0x00020000
#define GX_STYLE_HALIGN_RIGHT                   0x00040000
#define GX_STYLE_VALIGN_CENTER                  0x00080000
#define GX_STYLE_VALIGN_TOP                     0x00100000
#define GX_STYLE_VALIGN_BOTTOM                  0x00200000

#define GX_PIXELMAP_HALIGN_MASK                 0x00070000
#define GX_PIXELMAP_VALIGN_MASK                 0x00380000
...
/* define cursor flag */
#define GX_STYLE_CURSOR_SHOW                    0x00000010
#define GX_STYLE_CURSOR_DRAW                    0x00000020
...
#define GX_BRUSH_PIXELMAP                       0x0002          /* For rectangle, polygon                    */
...
#define GX_ALPHA_COMPRESSED        0x08                         /* Pixelmap has compressed alpha channel    */
#define GX_PIXELMAP_BGR_ORDER      0x10                         /* BGR (not RGB) order  */
#define GX_PIXELMAP_555_FORMAT     0x20                         /* 555 (not 565) format */
...
typedef struct GX_SCROLLBAR_APPEARANCE_STRUCT
{
    ...
    GX_RESOURCE_ID gx_scroll_fill_color;
...
typedef struct GX_DISPLAY_STRUCT
{
    ...
    VOID                     (*gx_display_driver_polygon_draw)(GX_DRAW_CONTEXT *context,
                                                               INT num, GX_POINT *vertex);

    /* Define driver function pointer for chart quadrangle fill.  */
    VOID                     (*gx_display_driver_chart_quadrangle_fill)(GX_DRAW_CONTEXT *context, GX_POINT *dot0,
                                                                        GX_POINT *dot1, GX_POINT *dot2, GX_POINT *dot3);

    /* Define driver function pointer for quadrangle fill.  */
    VOID                     (*gx_display_driver_quadrangle_fill)(GX_DRAW_CONTEXT *context, GX_POINT *dot0,
                                                                  GX_POINT *dot1, GX_POINT *dot2, GX_POINT *dot3);
...
#define GX_SINGLE_LINE_TEXT_INPUT_MEMBERS_DECLARE                                       \
    GX_PROMPT_MEMBERS_DECLARE                                                           \
    GX_CHAR                     *gx_text_input_buffer;                                  \
    UINT                        gx_text_buffer_size;                                    \
    UINT                        gx_text_input_string_size;                              \
    GX_VALUE                    gx_text_xoffset;                                        \
    GX_VALUE                    gx_text_yoffset;                                        \
    UINT                        gx_text_cursor_position;                                \
    UINT                        gx_text_was_modified;                                   
...
#define GX_VERTICAL_LIST_MEMBERS_DECLARE                                                \
    ...
    INT                         gx_vertical_list_seperation;                            \
    GX_WIDGET                   *gx_vertical_list_selected;                             \
    GX_WIDGET                   *gx_vertical_list_clicked;                              \
    INT                         gx_vertical_list_index;                                 \
    INT                         gx_vertical_list_total_rows;                            \
    INT                         gx_vertical_list_visible_rows;                          \
    INT                         gx_vertical_list_child_count;                           \
    INT                         gx_vertical_list_child_height;                          \
    INT                         gx_vertical_list_snap_back_distance;
...
#define GX_HORIZONTAL_LIST_MEMBERS_DECLARE                                              \
    ...
    INT                         gx_horizontal_list_seperation;                          \
    GX_WIDGET                   *gx_horizontal_list_selected;                           \
    GX_WIDGET                   *gx_horizontal_list_clicked;                            \
    INT                         gx_horizontal_list_index;                               \
    INT                         gx_horizontal_list_total_columns;                       \
    INT                         gx_horizontal_list_visible_columns;                     \
    INT                         gx_horizontal_list_child_count;                         \
    INT                         gx_horizontal_list_child_width;                         \
    INT                         gx_horizontal_list_snap_back_distance;
...
#define GX_MULTI_LINE_TEXT_VIEW_MEMBERS_DECLARE                                         \
    ...
    GX_CHAR                     *gx_multi_line_text_view_buffer;                        \
    UINT                        gx_multi_line_text_view_string_size;                    \
    UINT                        gx_multi_line_text_view_first_character_index;          \
    ...
    UINT                        gx_multi_line_text_view_text_row_index;                 \
    GX_FONT                     *gx_multi_line_text_view_font;                          \
    INT                         *gx_multi_line_text_view_char_index;                    \
    UINT                        gx_multi_line_text_view_first_line_index;
...
#define GX_MULTI_LINE_TEXT_INPUT_MEMBERS_DECLARE                                        \
    ...
    GX_POINT                   gx_multi_line_text_input_text_cursor_position;           \
...
#define gx_horizontal_list_selected_get(a, b)                    _gx_horizontal_list_selected_get(a, (GX_WIDGET **)b)
#define gx_horizontal_list_selected_set(a, b)                    _gx_horizontal_list_selected_set(a, (GX_WIDGET *)b)
...
#define gx_multi_line_text_input_cursor_flag_clear               _gx_multi_line_text_input_cursor_flag_clear
#define gx_multi_line_text_input_cursor_flag_set                 _gx_multi_line_text_input_cursor_flag_set
...
#define gx_single_line_text_input_character_insert(a, b)         _gx_single_line_text_input_character_insert(a, b)
...
#define gx_single_line_text_input_cursor_flag_set(a, b)          _gx_single_line_text_input_cursor_flag_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b);
#define gx_single_line_text_input_cursor_flag_clear(a, b)        _gx_single_line_text_input_cursor_flag_clear((GX_SINGLE_LINE_TEXT_INPUT *)a, b);
...
#define gx_vertical_list_selected_get(a, b)                      _gx_vertical_list_selected_get(a, (GX_WIDGET **)b)
#define gx_vertical_list_selected_set(a, b)                      _gx_vertical_list_selected_set(a, (GX_WIDGET *)b)
...
#define gx_widget_event_process_set(a, b)                        _gx_widget_event_process_set((GX_WIDGET *)a, b)
...
#define gx_widget_text_draw(a, b, c, d, e, f, g)                 _gx_widget_text_draw((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_id_draw(a, b, c, d, e, f, g)              _gx_widget_text_id_draw((GX_WIDGET *)a, b, c, d, e, f, g)
...
UINT _gx_canvas_polygon_draw(INT number_of_points, GX_POINT *point_array);
...
UINT _gx_display_color_set(GX_DISPLAY *display, GX_RESOURCE_ID color_id, GX_COLOR new_color);
...
UINT _gx_display_color_table_set(GX_DISPLAY *display, GX_COLOR *color_table, INT number_of_colors);
UINT _gx_display_font_table_set(GX_DISPLAY *display, GX_FONT **font_table, INT number_of_fonts);
UINT _gx_display_pixelmap_table_set(GX_DISPLAY *display, GX_PIXELMAP **pixelmap_table, INT number_of_pixelmaps);
...
UINT _gx_horizontal_list_selected_get(GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET **return_list_entry);
UINT _gx_horizontal_list_selected_set(GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET *list_entry);
...
UINT _gx_icon_button_create(GX_ICON_BUTTON *button,
                            ...
                            GX_CONST GX_RECTANGLE *size);
UINT _gx_icon_button_draw(GX_ICON_BUTTON *button);
...
UINT _gx_icon_event_process(GX_BUTTON *button, GX_EVENT *event_ptr);
...
UINT _gx_multi_line_text_input_cursor_flag_clear(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gx_multi_line_text_input_cursor_flag_set(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
...
UINT _gx_pixelmap_button_event_process(GX_BUTTON *button, GX_EVENT *event_ptr);
...
UINT _gx_single_line_text_input_character_insert(GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_CHAR character);
...
UINT _gx_single_line_text_input_cursor_flag_set(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gx_single_line_text_input_cursor_flag_clear(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
...
UINT _gx_vertical_list_selected_get(GX_VERTICAL_LIST *vertical_list, GX_WIDGET **return_list_entry);
UINT _gx_vertical_list_selected_set(GX_VERTICAL_LIST *vertical_list, GX_WIDGET *list_entry);
...
UINT _gx_widget_back_move(GX_WIDGET *widget, UINT *widget_moved);
...
UINT _gx_widget_event_generate(GX_WIDGET *widget, ULONG event_type, LONG value);
...
UINT _gx_widget_front_move(GX_WIDGET *widget, UINT *widget_moved);
...
UINT _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT fColor, UINT font_id, GX_CHAR *string,
                          INT x_offset, INT y_offset);

UINT _gx_widget_text_id_draw(GX_WIDGET *widget, UINT tColor, UINT fColor,
...
#define gx_context_font_get                                      _gxe_context_font_gete
...
#define gx_horizontal_list_selected_get(a, b)                    _gxe_horizontal_list_selected_get(a, (GX_WIDGET **)b)
#define gx_horizontal_list_selected_set(a, b)                    _gxe_horizontal_list_selected_set(a, (GX_WIDGET *)b)
...
#define gx_icon_button_draw                                      _gxe_icon_button_draw
...
#define gx_multi_line_text_input_cursor_flag_clear               _gxe_multi_line_text_input_cursor_flag_clear
#define gx_multi_line_text_input_cursor_flag_set                 _gxe_multi_line_text_input_cursor_flag_set
...
#define gx_single_line_text_input_character_insert(a, b)         _gxe_single_line_text_input_character_insert(a, b)
...
#define gx_single_line_text_input_cursor_flag_set(a, b)          _gxe_single_line_text_input_cursor_flag_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b);
#define gx_single_line_text_input_cursor_flag_clear(a, b)        _gxe_single_line_text_input_cursor_flag_clear((GX_SINGLE_LINE_TEXT_INPUT *)a, b);
...
#define gx_vertical_list_selected_get(a, b)                      _gxe_vertical_list_selected_get(a, (GX_WIDGET **)b)
#define gx_vertical_list_selected_set(a, b)                      _gxe_vertical_list_selected_set(a, (GX_WIDGET *)b)
...
#define gx_widget_event_process_set(a, b)                        _gxe_widget_event_process_set((GX_WIDGET *)a, b)
...
#define gx_widget_text_draw(a, b, c, d, e, f, g)                 _gxe_widget_text_draw((GX_WIDGET *)a, b, c, d, e, f, g)
#define gx_widget_text_id_draw(a, b, c, d, e, f, g)              _gxe_widget_text_id_draw((GX_WIDGET *)a, b, c, d, e, f, g)
...
UINT _gxe_canvas_polygon_draw(INT number_of_points, GX_POINT *point_array);
...
UINT _gxe_context_font_get(GX_RESOURCE_ID color_id, GX_FONT **return_font);
...
UINT _gxe_display_font_table_set(GX_DISPLAY *display, GX_FONT **font_table, INT number_of_fonts);
UINT _gxe_display_pixelmap_table_set(GX_DISPLAY *display, GX_PIXELMAP **pixelmap_table, INT number_of_pixelmaps);
...
UINT _gxe_horizontal_list_selected_get(GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET **return_list_entry);
UINT _gxe_horizontal_list_selected_set(GX_HORIZONTAL_LIST *horizontal_list, GX_WIDGET *list_entry);
...
UINT _gxe_icon_event_process(GX_CHECKBOX *checkbox, GX_EVENT *event_ptr);
...
UINT _gxe_multi_line_text_input_cursor_flag_clear(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gxe_multi_line_text_input_cursor_flag_set(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
...
UINT _gxe_pixelmap_button_event_process(GX_CHECKBOX *checkbox, GX_EVENT *event_ptr);
...
UINT _gxe_single_line_text_input_character_insert(GX_SINGLE_LINE_TEXT_INPUT *text_input, GX_CHAR character);
...
UINT _gxe_single_line_text_input_cursor_flag_set(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
UINT _gxe_single_line_text_input_cursor_flag_clear(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, ULONG cursor_type);
...
UINT _gxe_vertical_list_selected_get(GX_VERTICAL_LIST *vertical_list, GX_WIDGET **return_list_entry);
UINT _gxe_vertical_list_selected_set(GX_VERTICAL_LIST *vertical_list, GX_WIDGET *list_entry);
...
UINT _gxe_widget_back_move(GX_WIDGET *widget, UINT *widget_moved);
...
UINT _gxe_widget_event_generate(GX_WIDGET *widget, ULONG event_type, LONG value);
...
UINT _gxe_widget_front_move(GX_WIDGET *widget, UINT *widget_moved);
...
UINT _gxe_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT fColor, UINT font_id, GX_CHAR *string,
                           INT x_offset, INT y_offset);

UINT _gxe_widget_text_id_draw(GX_WIDGET *widget, UINT tColor, UINT fColor,
                              UINT font_id, UINT text_id,
                              INT x_offset, INT y_offset);
...
#ifdef GUIX_MULTITHREAD_SUPPORT
