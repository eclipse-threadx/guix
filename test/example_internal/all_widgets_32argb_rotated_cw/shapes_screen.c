...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_32argb_rotated_cw_resources.h"
#include "all_widgets_32argb_rotated_cw_specifications.h"
...
GX_RESOURCE_ID pixelmap_id[2] = {GX_PIXELMAP_ID__32ARGB_A, GX_PIXELMAP_ID__32ARGB_C_A};
