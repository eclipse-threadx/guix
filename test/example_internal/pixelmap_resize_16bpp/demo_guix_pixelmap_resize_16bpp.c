...
VOID tx_application_define(void *first_unused_memory)
{
    ...
    /* create byte pool for rotation to use */
...
INT width, height;
    ...
    pixelmap = (GX_PIXELMAP *)display_1_theme_1_pixelmap_table[pixelmap_id];
    ...
    if(gx_utility_pixelmap_resize(pixelmap, &destination, width, height) == GX_SUCCESS)
    {
        ...
        {
            resize_memory_free((VOID *)destination.gx_pixelmap_aux_data);
        }
    }
}
