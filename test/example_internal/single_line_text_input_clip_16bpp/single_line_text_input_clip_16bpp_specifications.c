...
GX_STUDIO_DISPLAY_INFO single_line_text_input_clip_16bpp_display_table[1] =
{
    {
    "display_1",
    "display_1_canvas",
...
UINT gx_studio_text_input_create(GX_CONST GX_STUDIO_WIDGET *info, GX_WIDGET *control_block, GX_WIDGET *parent)
{
    ...
    if (status == GX_SUCCESS)
    {
        ...
        {
             gx_display_string_get_ext(single_line_text_input_clip_16bpp_display_table[0].display, props->string_id, &text);
...
GX_CHAR main_window_text_input_1bpp_buffer[100];
GX_SINGLE_LINE_TEXT_INPUT_PROPERTIES main_window_text_input_1bpp_properties =
{
    0,                                       /* string id                      */
    ...
    main_window_text_input_1bpp_buffer,      /* buffer                         */
    100,                                     /* buffer size                    */
};
...
GX_CHAR main_window_text_input_4bpp_buffer[100];
GX_SINGLE_LINE_TEXT_INPUT_PROPERTIES main_window_text_input_4bpp_properties =
{
    0,                                       /* string id                      */
    ...
    GX_COLOR_ID_READONLY_FILL,               /* readonly fill color            */
    GX_COLOR_ID_READONLY_TEXT,               /* readonly text color            */
    main_window_text_input_4bpp_buffer,      /* buffer                         */
    100,                                     /* buffer size                    */
};
GX_CHAR main_window_text_input_8bpp_buffer[100];
GX_SINGLE_LINE_TEXT_INPUT_PROPERTIES main_window_text_input_8bpp_properties =
{
    0,                                       /* string id                      */
    ...
    GX_COLOR_ID_READONLY_FILL,               /* readonly fill color            */
    GX_COLOR_ID_READONLY_TEXT,               /* readonly text color            */
    main_window_text_input_8bpp_buffer,      /* buffer                         */
    100,                                     /* buffer size                    */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_text_input_8bpp_define =
{
    "text_input_8bpp",
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {37, 161, 217, 190},                     /* widget size                    */
    &main_window_prompt_6_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_text_input_8bpp), /* control block */
    (void *) &main_window_text_input_8bpp_properties /* extended properties    */
};

GX_CONST GX_STUDIO_WIDGET main_window_text_input_4bpp_define =
{
    "text_input_4bpp",
    GX_TYPE_SINGLE_LINE_TEXT_INPUT,          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {37, 103, 217, 132},                     /* widget size                    */
    &main_window_text_input_8bpp_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_text_input_4bpp), /* control block */
    (void *) &main_window_text_input_4bpp_properties /* extended properties    */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_prompt_5_define =
{
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {37, 25, 116, 46},                       /* widget size                    */
    &main_window_text_input_4bpp_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_window_text_input_1bpp_define =
{
    "text_input_1bpp",
    GX_TYPE_SINGLE_LINE_TEXT_INPUT,          /* widget type                    */
    GX_ID_NONE,                              /* widget id                      */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {37, 45, 217, 74},                       /* widget size                    */
    &main_window_prompt_5_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(MAIN_WINDOW_CONTROL_BLOCK, main_window_text_input_1bpp), /* control block */
    (void *) &main_window_text_input_1bpp_properties /* extended properties    */
};
...
GX_CONST GX_STUDIO_WIDGET main_window_prompt_4_define =
{
    ...
    &main_window_text_input_1bpp_define,     /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
...
GX_CONST GX_STUDIO_WIDGET main_window_define =
{
    ...
    GX_NULL,                                 /* next widget                    */
    &main_window_slider_1_define,            /* child widget                   */
    0,                                       /* control block                  */
    (void *) &main_window_properties         /* extended properties            */
};
GX_CONST GX_STUDIO_WIDGET_ENTRY single_line_text_input_clip_16bpp_widget_table[] =
{
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = single_line_text_input_clip_16bpp_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &single_line_text_input_clip_16bpp_display_table[display];
