...
#include <stdio.h>
#include "gx_api.h"
#include "all_widgets_24xrgb_rotated_ccw_binary_resources.h"
#include "all_widgets_24xrgb_rotated_ccw_binary_specifications.h"
...
VOID select_day()
{
    ...
    gx_widget_find(&scroll_wheel_screen, ID_DAY_WHEEL, GX_SEARCH_DEPTH_INFINITE, &day_wheel);

    gx_widget_find(&scroll_wheel_screen, ID_DAY_INPUT, GX_SEARCH_DEPTH_INFINITE, &input);
...
VOID animation_speed_set()
{
    ...
    gx_widget_find(&scroll_wheel_screen, ID_DAY_WHEEL, GX_SEARCH_DEPTH_INFINITE, &day_wheel);
    gx_widget_find(&scroll_wheel_screen, ID_YEAR_WHEEL, GX_SEARCH_DEPTH_INFINITE, &year_wheel);
    gx_widget_find(&scroll_wheel_screen, ID_MONTH_WHEEL, GX_SEARCH_DEPTH_INFINITE, &month_wheel);
