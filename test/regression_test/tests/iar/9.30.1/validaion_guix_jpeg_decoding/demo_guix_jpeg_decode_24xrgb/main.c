...
#include "demo_jpeg_decode_24xrgb_resources.h"
#include "demo_jpeg_decode_24xrgb_specifications.h"
...
GX_CANVAS *canvas;
    ...
    gx_studio_display_configure(DISPLAY_1, graphics_driver_24xrgb_setup, LANGUAGE_ENGLISH, DISPLAY_1_THEME_1, &root);
