...
#include "demo_jpeg_decode_565rgb_resources.h"
#include "demo_jpeg_decode_565rgb_specifications.h"
...
GX_CANVAS *canvas;
    ...
    gx_studio_display_configure(DISPLAY_1, graphics_driver_565rgb_setup, LANGUAGE_ENGLISH, DISPLAY_1_THEME_1, &root);
