#ifndef _PIXELMAP_BUTTON_SERVICE_PROVIDER_
#define _PIXELMAP_BUTTON_SERVICE_PROVIDER_

class screen_generator; // forward reference

class pixelmap_button_service_provider : public button_service_provider
{
    public:
        pixelmap_button_service_provider();

        virtual int GetType() {return GX_TYPE_PIXELMAP_BUTTON;}
        virtual CString GetTypeName(widget_info *) {return CString("GX_TYPE_PIXELMAP_BUTTON");}
        virtual CString GetShortName() {return CString("pixelmap_button");}
        virtual CString GetVarDeclaration();
        virtual CString GetControlBlockName() {return CString("GX_PIXELMAP_BUTTON");}
