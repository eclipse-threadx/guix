...
horizontal_list_service_provider::horizontal_list_service_provider()
{
}

CString horizontal_list_service_provider::GetVarDeclaration()
{
    return CString("GX_HORIZONTAL_LIST_MEMBERS_DECLARE");
}

CString horizontal_list_service_provider::DeclarePropertiesStruct()
{
    CString out(""
   "typedef struct\n"
    "{\n"
...
CString horizontal_list_service_provider::WriteExtendedProperties(screen_generator *gen, CString &prefix, widget_info *info)
{
    CString out;
    ...
    out.Format(_T("GX_HORIZONTAL_LIST_PROPERTIES %s_properties =\n")
        _T("{\n")
        _T("    %s, /* wallpaper id */\n")
...
CString horizontal_list_service_provider::GetCreateFromDefFunctionName()
{
    return CString("gx_studio_horizontal_list_create");
}

CString horizontal_list_service_provider::GetCreateFromDefFunction(int version)
{
    CString out;
    MakeCreatePreamble("horizontal_list", version, out);
...
widget_info *horizontal_list_service_provider::CreateNewInstance(GX_WIDGET *parent)
{
    int parent_size;
    ...
    GX_HORIZONTAL_LIST *list = new GX_HORIZONTAL_LIST;
    gx_horizontal_list_create(list, "horizontal_list", parent,
...
GX_WIDGET *horizontal_list_service_provider::GenerateFromInfo(GX_WIDGET *parent, widget_info *info)
{
    GX_HORIZONTAL_LIST *list = new GX_HORIZONTAL_LIST;
    gx_horizontal_list_create(list,
...
void horizontal_list_service_provider::SaveToProject(xml_writer &writer, studiox_project *project, int display, widget_info *info)
{
...
void horizontal_list_service_provider::ReadFromProject(xml_reader &reader, studiox_project *project, int display, widget_info *info, ULONG valid_styles)
{
