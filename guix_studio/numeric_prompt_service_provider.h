#ifndef _NUMERIC_PROMPT_SERVICE_PROVIDER_
#define _NUMERIC_PROMPT_SERVICE_PROVIDER_

class screen_generator; // forward reference

class numeric_prompt_service_provider : public prompt_service_provider
{
public:
    numeric_prompt_service_provider();

    virtual int GetType() { return GX_TYPE_NUMERIC_PROMPT; }
    virtual CString GetTypeName(widget_info *) { return CString("GX_TYPE_NUMERIC_PROMPT"); }
    virtual CString GetShortName() { return CString("numeric_prompt"); }
    virtual CString GetVarDeclaration();
    virtual CString GetControlBlockName() { return CString("GX_NUMERIC_PROMPT"); }
