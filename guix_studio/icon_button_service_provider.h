#ifndef _ICON_BUTTON_SERVICE_PROVIDER_
#define _ICON_BUTTON_SERVICE_PROVIDER_

class screen_generator; // forward reference

class icon_button_service_provider : public button_service_provider
{
    public:
        icon_button_service_provider();

        virtual int GetType() {return GX_TYPE_ICON_BUTTON;}
        virtual CString GetTypeName(widget_info *) {return CString("GX_TYPE_ICON_BUTTON");}
        virtual CString GetShortName() {return CString("icon_button");}
        virtual CString GetVarDeclaration();
        virtual CString GetControlBlockName() {return CString("GX_ICON_BUTTON");}
